...
export class AppComponent {
  ...
  public bubbleSettings: Object = [{
    ...
    dataSource: [
      { name: 'India', population: '38332521', populationColor: 'green' },
      { name: 'New Zealand', population: '19651127', populationColor: 'green' },
      { name: 'Pakistan', population: '3090416', populationColor: 'green' },
      { name: 'United Arab Emirates', population: '38332521', populationColor: 'green' },
      { name: 'United Kingdom', population: '38332521', populationColor: 'green' },
      { name: 'United States', population: '38332521', populationColor: 'green' }
    ],
    maxRadius: 10,
  ...
  onClick(event) {
    ...
    console.log(this.doughnutChartProperties.data[event.selection[0].row]);
  }
}
