...
var XamMultiScaleImageView = /** @class */ (function (_super) {
        ...
        var _loop_1 = function (b) {
            if (a == this_1.i._inner[b]) {
                if (a.h != null && a.h.ac != null) {
                    var c = a.h.ac;
                    var d_1 = c.c;
                    var e_1 = this_1.b.ao.u(a.e + 8, a.c, a.d);
                    if (e_1 != null) {
                        var f = ((function () {
    ...
    XamMultiScaleImageView.prototype.q = function () {
        ...
        if (index_ >= 0) {
            ...
            var b = new WriteableBitmap(this.b.ao.p, this.b.ao.n);
            ...
            this.j.removeAt(0);
            var e = this.b.ao.u(this.i._inner[index_].e + 8, this.i._inner[index_].c, this.i._inner[index_].d);
            if (e == null) {
                return;
            }
            var f_1 = e.value;
...
var XamMultiScaleTileSource = /** @class */ (function (_super) {
    ...
    Object.defineProperty(XamMultiScaleTileSource.prototype, "t", {
        get: function () {
            return this.r;
        },
        set: function (a) {
    ...
    Object.defineProperty(XamMultiScaleTileSource.prototype, "s", {
        get: function () {
            return this.q;
        },
        set: function (a) {
    ...
    XamMultiScaleTileSource.prototype.u = function (a, b, c) {
    ...
    XamMultiScaleTileSource.prototype.w = function (a, b, c, d) {
        if (this.k != null) {
            this.k.bp(a, b, c, d);
        }
    };
...
var XamMultiScaleImage = /** @class */ (function (_super) {
    ...
    XamMultiScaleImage.prototype.ba = function () {
        if (!stringIsNullOrEmpty(this.bc)) {
            return this.bc;
        }
        return null;
    };
    XamMultiScaleImage.prototype.bb = function () {
        if (!stringIsNullOrEmpty(this.bg)) {
            return this.bg;
        }
        return null;
    };
    XamMultiScaleImage.prototype.bu = function (a, b, c) {
    ...
    XamMultiScaleImage.prototype.bp = function (a, b, c, d) {
        this.b1();
        this.b4();
        this.b2();
    };
    ...
    XamMultiScaleImage.prototype.b6 = function () {
        var a = 2;
    ...
    XamMultiScaleImage.prototype.b3 = function (a) {
        ...
        var b = truncate(Math.ceil(this.cj.width / this.ao.p));
        ...
        var e = this.a0;
        var f = this.cj.height * e / this.cj.width;
        var g = this.ao.t / Math.pow(2, c);
        var h = this.ao.s / Math.pow(2, c);
        var i = Math.max(truncate(Math.floor((this.cg.x * this.ao.t) / g)), 0);
        var j = Math.min(truncate(Math.ceil(((this.cg.x + e) * this.ao.t) / g)), d);
        var k = Math.max(truncate(Math.floor((this.cg.y * this.ao.s) / h)), 0);
        var l = Math.min(truncate(Math.ceil(((this.cg.y + f) * this.ao.t) / h)), d);
        var m = ((i * g) - (this.cg.x * this.ao.t)) / g;
        var n = ((k * h) - (this.cg.y * this.ao.s)) / h;
        var o = (e * this.ao.t / g) * (this.ao.p / this.cj.width);
        ...
        var _loop_3 = function (t) {
            ...
            var ab = this_3.ao.p / o;
            var ac = this_3.ao.n / o;
    ...
    XamMultiScaleImage.prototype.b1 = function () {
        this.ar.i();
    };
    XamMultiScaleImage.prototype.am = function (a) {
        return this.ar.item(a);
    };
    XamMultiScaleImage.prototype.bl = function (a, b) {
        this.ar.item(a, b);
    };
    ...
    XamMultiScaleImage.prototype.bo = function () {
        var a = dateNow();
        var b = 0.5;
