...
var IgxObjectCollection = /** @class */ (function (_super) {
    tslib_1.__extends(IgxObjectCollection, _super);
    function IgxObjectCollection(list) {
    ...
    IgxObjectCollection.prototype._createInnerColl = function () {
    ...
    return IgxObjectCollection;
}(IgCollection));
export { IgxObjectCollection };
