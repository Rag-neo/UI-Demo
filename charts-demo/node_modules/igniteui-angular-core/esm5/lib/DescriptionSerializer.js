...
var DescriptionSerializer = /** @class */ (function (_super) {
    ...
    DescriptionSerializer.prototype.o = function (a, b, c) {
        this.l(a, b, c);
    };
    ...
    DescriptionSerializer.prototype.b = function (a, b, c) {
        ...
        for (var j = 0; j < i.length; j++) {
            var k = i[j];
            var l = a.b(g, TypeDescriptionContext.l(k));
            if (l == null) {
                if (TypeDescriptionContext.l(k) == "Name") {
                    var m = "string";
                    var n = b.item(k);
                    var o = this.f(f, a, n, m);
                    h.name = o;
                }
                continue;
            }
            ...
            if (l.knownType == 14 || l.knownType == 11 || l.knownType == 12) {
                ...
                var v = this.a(f, a, t, u);
                a.o(h, k, v);
            }
            else {
                var w = l.specificExternalType;
    ...
    DescriptionSerializer.prototype.g = function (a, b) {
        if (b == null) {
            return null;
        }
        var c = NaN;
    ...
    DescriptionSerializer.prototype.i = function (a, b) {
        if (b == null) {
            return null;
        }
        var c = NaN;
    ...
    DescriptionSerializer.prototype.j = function (a) {
        if (a == null) {
            return null;
        }
        return a.substr(0, 1).toLowerCase() + a.substr(1);
    };
    DescriptionSerializer.prototype.m = function (a, b, c, d) {
    ...
    DescriptionSerializer.prototype.p = function (a, b, c, d, e) {
        var f = 2;
        if (c.a != null) {
            f = c.a.knownType;
        }
    ...
    DescriptionSerializer.prototype.n = function (a, b, c, d) {
