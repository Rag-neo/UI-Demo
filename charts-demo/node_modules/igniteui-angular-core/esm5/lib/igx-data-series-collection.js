...
var IgxDataSeriesCollection = /** @class */ (function (_super) {
    tslib_1.__extends(IgxDataSeriesCollection, _super);
    function IgxDataSeriesCollection(list) {
    ...
    IgxDataSeriesCollection.prototype._createInnerColl = function () {
        if (!DataSeries.$type) {
            DataSeries.$type = markType(DataSeries, "DataSeries");
        }
    ...
    return IgxDataSeriesCollection;
}(IgCollection));
export { IgxDataSeriesCollection };
