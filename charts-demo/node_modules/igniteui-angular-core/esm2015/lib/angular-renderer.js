...
export class AngularRenderer {
    constructor(container, renderer, document, ngZone, useDefaultsSource, defaultsSource, portalManager = null) {
...
export class PortalManager {
    constructor(id, componentFactoryResolver) {
    ...
    onChildContentChanged(template) {
    ...
    getPortal(hostElement, elementTag, portalCallback, isContentPortal) {
        let portal = new AngularDomPortal(this, hostElement, elementTag, portalCallback, this.getId(), this._dynamicContent, this._componentFactoryResolver, isContentPortal);
...
class AngularDomPortal {
    constructor(portalManager, hostElement, elementTag, portalCallback, portalId, dynamicContent, componentFactoryResolver, isContentPortal) {
    ...
    _onDynamicContentProvided(value) {
    ...
    createElementFromTag(elementTag, portalId, dynamicContent, componentFactoryResolver) {
