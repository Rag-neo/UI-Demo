 ...
 * @hidden
 */
export class GridColumnWidthChangedEventArgsDescriptionMetadata extends Base {
    static b(a) {
    ...
    static d(a) {
        ...
        a.n("GridColumnWidthChangedEventArgs", () => new GridColumnWidthChangedEventArgsDescription());
