 ...
 * @hidden
 */
export class GridCellValueChangedEventArgsDescriptionMetadata extends Base {
    static b(a) {
    ...
    static d(a) {
        ...
        a.n("GridCellValueChangedEventArgs", () => new GridCellValueChangedEventArgsDescription());
