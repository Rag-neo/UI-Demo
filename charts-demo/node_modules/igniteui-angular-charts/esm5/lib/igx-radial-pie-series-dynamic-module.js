...
var IgxRadialPieSeriesDynamicModule = /** @class */ (function () {
    function IgxRadialPieSeriesDynamicModule() {
    ...
    IgxRadialPieSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRadialPieSeriesDynamicModule;
}());
export { IgxRadialPieSeriesDynamicModule };
//# sourceMappingURL=igx-radial-pie-series-dynamic-module.js.map