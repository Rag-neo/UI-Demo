...
var IgxTimeXAxisDynamicModule = /** @class */ (function () {
    function IgxTimeXAxisDynamicModule() {
        TypeRegistrar.registerCons("IgxTimeXAxisComponent", IgxTimeXAxisComponent);
        TypeRegistrar.register("TimeXAxis", TimeXAxis.$type);
    }
    IgxTimeXAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxTimeXAxisDynamicModule;
}());
export { IgxTimeXAxisDynamicModule };
//# sourceMappingURL=igx-time-x-axis-dynamic-module.js.map