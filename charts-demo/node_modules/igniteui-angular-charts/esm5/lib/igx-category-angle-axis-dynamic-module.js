...
var IgxCategoryAngleAxisDynamicModule = /** @class */ (function () {
    function IgxCategoryAngleAxisDynamicModule() {
    ...
    IgxCategoryAngleAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCategoryAngleAxisDynamicModule;
}());
export { IgxCategoryAngleAxisDynamicModule };
//# sourceMappingURL=igx-category-angle-axis-dynamic-module.js.map