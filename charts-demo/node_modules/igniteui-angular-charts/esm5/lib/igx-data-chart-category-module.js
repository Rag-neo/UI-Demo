...
var IgxDataChartCategoryModule = /** @class */ (function () {
    function IgxDataChartCategoryModule() {
    }
    IgxDataChartCategoryModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartCategoryModule;
}());
export { IgxDataChartCategoryModule };
//# sourceMappingURL=igx-data-chart-category-module.js.map