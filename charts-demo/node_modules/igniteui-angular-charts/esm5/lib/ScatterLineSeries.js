...
import { Point_$type, typeCast, Number_$type, enumGetBox, markType, markDep } from "igniteui-angular-core";
 ...
 * @hidden
 */
var ScatterLineSeries = /** @class */ (function (_super) {
    ...
    ScatterLineSeries.prototype.o2 = function (a, b) {
        var c = this.bi;
        var d = c.da;
        return this.di(a, b, d.ak);
    };
    ScatterLineSeries.prototype.n6 = function (a, b) {
        var _this = this;
        ...
        var h = new ScalerParams(0, c, d, this.m8.d, e);
        var i = ((function () {
            var $ret = new ScalerParams(0, c, d, _this.m8.e, e);
            $ret.b = _this.eh();
            return $ret;
        })());
        var j = arrayShallowClone(this.nh.asArray());
        var k = arrayShallowClone(this.nj.asArray());
    ...
    ScatterLineSeries.prototype.o9 = function (a, b, c, d) {
        if (c == d) {
    ...
    ScatterLineSeries.prototype.of = function (a, b) {
        b.c0(false);
        ...
        this.o7(d.da, a.m.count, function (e) { return a.m._inner[e].x; }, function (e) { return a.m._inner[e].y; }, this.o1, this.eu);
    };
    ScatterLineSeries.prototype.o7 = function (a, b, c, d, e, f) {
    ...
    ScatterLineSeries.prototype.o6 = function (a, b, c, d, e, f) {
        if (c > -1) {
            var g = this.eu;
            var h = this.o3(new List$1(Number_$type, 0), d, e, b, c, g);
            var i = void 0;
    ...
    ScatterLineSeries.prototype.i0 = function (a, b, c, d) {
    ...
    ScatterLineSeries.$$p = markDep(DependencyProperty, PropertyMetadata, ScatterLineSeries, 'raisePropertyChanged', ['UnknownValuePlotting:o1:o8', [UnknownValuePlotting_$type, enumGetBox(UnknownValuePlotting_$type, 1)]]);
