...
var IgxCategoryChartCoreDynamicModule = /** @class */ (function () {
    function IgxCategoryChartCoreDynamicModule() {
        TypeRegistrar.registerCons('IgxCategoryChartComponent', IgxCategoryChartComponent);
    }
    IgxCategoryChartCoreDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxCategoryChartCoreDynamicModule);
    return IgxCategoryChartCoreDynamicModule;
}());
export { IgxCategoryChartCoreDynamicModule };
//# sourceMappingURL=igx-category-chart-core-dynamic-module.js.map