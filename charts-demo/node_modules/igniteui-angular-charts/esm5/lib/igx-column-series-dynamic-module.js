...
var IgxColumnSeriesDynamicModule = /** @class */ (function () {
    function IgxColumnSeriesDynamicModule() {
    ...
    IgxColumnSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxColumnSeriesDynamicModule;
}());
export { IgxColumnSeriesDynamicModule };
//# sourceMappingURL=igx-column-series-dynamic-module.js.map