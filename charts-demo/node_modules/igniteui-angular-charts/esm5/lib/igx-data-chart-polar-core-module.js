...
var IgxDataChartPolarCoreModule = /** @class */ (function () {
    function IgxDataChartPolarCoreModule() {
    }
    IgxDataChartPolarCoreModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartPolarCoreModule;
}());
export { IgxDataChartPolarCoreModule };
//# sourceMappingURL=igx-data-chart-polar-core-module.js.map