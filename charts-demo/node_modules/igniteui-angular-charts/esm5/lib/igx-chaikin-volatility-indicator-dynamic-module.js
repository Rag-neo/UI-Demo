...
var IgxChaikinVolatilityIndicatorDynamicModule = /** @class */ (function () {
    function IgxChaikinVolatilityIndicatorDynamicModule() {
    ...
    IgxChaikinVolatilityIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxChaikinVolatilityIndicatorDynamicModule;
}());
export { IgxChaikinVolatilityIndicatorDynamicModule };
//# sourceMappingURL=igx-chaikin-volatility-indicator-dynamic-module.js.map