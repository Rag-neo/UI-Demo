...
var IgxAverageTrueRangeIndicatorDynamicModule = /** @class */ (function () {
    function IgxAverageTrueRangeIndicatorDynamicModule() {
    ...
    IgxAverageTrueRangeIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAverageTrueRangeIndicatorDynamicModule;
}());
export { IgxAverageTrueRangeIndicatorDynamicModule };
//# sourceMappingURL=igx-average-true-range-indicator-dynamic-module.js.map