...
var IgxAreaFragmentDynamicModule = /** @class */ (function () {
    function IgxAreaFragmentDynamicModule() {
    ...
    IgxAreaFragmentDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAreaFragmentDynamicModule;
}());
export { IgxAreaFragmentDynamicModule };
//# sourceMappingURL=igx-area-fragment-dynamic-module.js.map