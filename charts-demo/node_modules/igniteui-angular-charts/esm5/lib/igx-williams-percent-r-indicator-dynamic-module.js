...
var IgxWilliamsPercentRIndicatorDynamicModule = /** @class */ (function () {
    function IgxWilliamsPercentRIndicatorDynamicModule() {
    ...
    IgxWilliamsPercentRIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxWilliamsPercentRIndicatorDynamicModule;
}());
export { IgxWilliamsPercentRIndicatorDynamicModule };
//# sourceMappingURL=igx-williams-percent-r-indicator-dynamic-module.js.map