...
var IgxDataChartShapeDynamicModule = /** @class */ (function () {
    function IgxDataChartShapeDynamicModule() {
    }
    IgxDataChartShapeDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxDataChartShapeDynamicModule);
    return IgxDataChartShapeDynamicModule;
}());
export { IgxDataChartShapeDynamicModule };
//# sourceMappingURL=igx-data-chart-shape-dynamic-module.js.map