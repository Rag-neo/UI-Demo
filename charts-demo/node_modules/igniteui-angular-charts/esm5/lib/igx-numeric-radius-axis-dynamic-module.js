...
var IgxNumericRadiusAxisDynamicModule = /** @class */ (function () {
    function IgxNumericRadiusAxisDynamicModule() {
    ...
    IgxNumericRadiusAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxNumericRadiusAxisDynamicModule;
}());
export { IgxNumericRadiusAxisDynamicModule };
//# sourceMappingURL=igx-numeric-radius-axis-dynamic-module.js.map