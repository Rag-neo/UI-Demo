...
var IgxPercentChangeYAxisDynamicModule = /** @class */ (function () {
    function IgxPercentChangeYAxisDynamicModule() {
    ...
    IgxPercentChangeYAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPercentChangeYAxisDynamicModule;
}());
export { IgxPercentChangeYAxisDynamicModule };
//# sourceMappingURL=igx-percent-change-y-axis-dynamic-module.js.map