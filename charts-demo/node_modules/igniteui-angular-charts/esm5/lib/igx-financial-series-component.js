...
* ```
*/
export var IgxFinancialSeriesComponent_PROVIDERS = [{ provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxFinancialSeriesComponent; }) }];
var IgxFinancialSeriesComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxFinancialSeriesComponent, _super);
    function IgxFinancialSeriesComponent() {
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "i", {
        /**
                                     * @hidden
                                     */
        get: function () {
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "isFinancial", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "negativeBrush", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "xAxis", {
        /**
        ...
        */
        get: function () {
            ...
            if (!this.i.l9.externalObject) {
                var e = IgxCategoryAxisBaseComponent._createFromInternal(this.i.l9);
                if (e) {
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "yAxis", {
        /**
        ...
        */
        get: function () {
            ...
            if (!this.i.mu.externalObject) {
                var e = IgxNumericYAxisComponent._createFromInternal(this.i.mu);
                if (e) {
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "openMemberPath", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "highMemberPath", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "lowMemberPath", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "closeMemberPath", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "volumeMemberPath", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "isCustomCategoryStyleAllowed", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "transitionInMode", {
        /**
        ...
        */
        ...
        set: function (v) {
            this.i.mj = ensureEnum(CategoryTransitionInMode_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "isTransitionInEnabled", {
        /**
        ...
        */
        ...
        set: function (v) {
            this.i.ng = ensureBool(v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "isNegativeColorSupported", {
        /**
    ...
    IgxFinancialSeriesComponent.prototype.findByName = function (name) {
    ...
    IgxFinancialSeriesComponent.prototype._styling = function (container, component, parent) {
    ...
    IgxFinancialSeriesComponent.prototype.getItemValue = function (item, memberPathName) {
        var iv = this.i.fs(item, memberPathName);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getPreviousOrExactIndex = function (world, skipUnknowns) {
        var iv = this.i.fe(toPoint(world), skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getNextOrExactIndex = function (world, skipUnknowns) {
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.getOffsetValue = function () {
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.getCategoryWidth = function () {
        var iv = this.i.getCategoryWidth();
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesValuePosition = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.lm(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.en(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesHighValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.ej(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesLowValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.el(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesCloseValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.n1(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesOpenValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.n2(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesVolumeValue = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.n3(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesHighValuePosition = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.li(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesLowValuePosition = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.lk(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesOpenValuePosition = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.ph(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesCloseValuePosition = function (world, useInterpolation, skipUnknowns) {
        var iv = this.i.pg(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgxFinancialSeriesComponent.prototype.getSeriesVolumeValuePosition = function (world, useInterpolation, skipUnknowns) {
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.canUseAsYAxis = function (axis) {
        var iv = this.i.nb(axis);
        return (iv);
    };
    /**
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.canUseAsXAxis = function (axis) {
        var iv = this.i.na(axis);
        return (iv);
    };
    /**
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.getExactItemIndex = function (world) {
    ...
    * ```
    */
    IgxFinancialSeriesComponent.prototype.getItemIndex = function (world) {
    ...
    */
    IgxFinancialSeriesComponent.prototype.getItem = function (world) {
        var iv = this.i.fp(toPoint(world));
        return (iv);
    };
    IgxFinancialSeriesComponent.prototype.setNegativeColors = function (negativeBrush, negativeOutline) {
        this.i.jj(stringToBrush(negativeBrush), stringToBrush(negativeOutline));
    };
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "assigningCategoryStyle", {
        /**
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "typical", {
        /**
        ...
        */
        get: function () {
            ...
            if (this._typical == null) {
                this._typical = new EventEmitter();
                this.i.typical = delegateCombine(this.i.typical, function (o, e) {
    ...
    Object.defineProperty(IgxFinancialSeriesComponent.prototype, "typicalBasedOn", {
        /**
        ...
        */
        get: function () {
            ...
            if (this._typicalBasedOn == null) {
                this._typicalBasedOn = new EventEmitter();
                this.i.typicalBasedOn = delegateCombine(this.i.typicalBasedOn, function (o, e) {
                    _this._runInZone(function () {
                        var outerArgs = new IgxFinancialEventArgs();
                        outerArgs._provideImplementation(e);
    ...
    ], IgxFinancialSeriesComponent.prototype, "negativeBrush", null);
    tslib_1.__decorate([
        Input(),
    ...
    ], IgxFinancialSeriesComponent.prototype, "xAxis", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", IgxNumericYAxisComponent),
        tslib_1.__metadata("design:paramtypes", [IgxNumericYAxisComponent])
    ], IgxFinancialSeriesComponent.prototype, "yAxis", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", String),
        tslib_1.__metadata("design:paramtypes", [String])
    ], IgxFinancialSeriesComponent.prototype, "openMemberPath", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", String),
        tslib_1.__metadata("design:paramtypes", [String])
    ], IgxFinancialSeriesComponent.prototype, "highMemberPath", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", String),
        tslib_1.__metadata("design:paramtypes", [String])
    ], IgxFinancialSeriesComponent.prototype, "lowMemberPath", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", String),
        tslib_1.__metadata("design:paramtypes", [String])
    ], IgxFinancialSeriesComponent.prototype, "closeMemberPath", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", String),
        tslib_1.__metadata("design:paramtypes", [String])
    ], IgxFinancialSeriesComponent.prototype, "volumeMemberPath", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", Boolean),
        tslib_1.__metadata("design:paramtypes", [Boolean])
    ], IgxFinancialSeriesComponent.prototype, "isCustomCategoryStyleAllowed", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", Number),
        tslib_1.__metadata("design:paramtypes", [Number])
    ], IgxFinancialSeriesComponent.prototype, "transitionInMode", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", Boolean),
        tslib_1.__metadata("design:paramtypes", [Boolean])
    ], IgxFinancialSeriesComponent.prototype, "isTransitionInEnabled", null);
    tslib_1.__decorate([
        Output(),
        tslib_1.__metadata("design:type", EventEmitter),
        tslib_1.__metadata("design:paramtypes", [])
    ], IgxFinancialSeriesComponent.prototype, "assigningCategoryStyle", null);
    tslib_1.__decorate([
        Output(),
        tslib_1.__metadata("design:type", EventEmitter),
        tslib_1.__metadata("design:paramtypes", [])
    ], IgxFinancialSeriesComponent.prototype, "typical", null);
    tslib_1.__decorate([
        Output(),
        tslib_1.__metadata("design:type", EventEmitter),
        tslib_1.__metadata("design:paramtypes", [])
    ], IgxFinancialSeriesComponent.prototype, "typicalBasedOn", null);
    return IgxFinancialSeriesComponent;
}(IgxSeriesComponent));
export { IgxFinancialSeriesComponent };
//# sourceMappingURL=igx-financial-series-component.js.map