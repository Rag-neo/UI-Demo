...
var IgxCustomPaletteColorScaleDynamicModule = /** @class */ (function () {
    function IgxCustomPaletteColorScaleDynamicModule() {
    ...
    IgxCustomPaletteColorScaleDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCustomPaletteColorScaleDynamicModule;
}());
export { IgxCustomPaletteColorScaleDynamicModule };
//# sourceMappingURL=igx-custom-palette-color-scale-dynamic-module.js.map