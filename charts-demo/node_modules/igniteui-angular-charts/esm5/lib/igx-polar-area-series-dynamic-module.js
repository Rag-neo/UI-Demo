...
var IgxPolarAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxPolarAreaSeriesDynamicModule() {
    ...
    IgxPolarAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPolarAreaSeriesDynamicModule;
}());
export { IgxPolarAreaSeriesDynamicModule };
//# sourceMappingURL=igx-polar-area-series-dynamic-module.js.map