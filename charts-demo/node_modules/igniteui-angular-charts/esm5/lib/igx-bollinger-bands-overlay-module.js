...
var IgxBollingerBandsOverlayModule = /** @class */ (function () {
    function IgxBollingerBandsOverlayModule() {
    }
    IgxBollingerBandsOverlayModule = tslib_1.__decorate([
        NgModule({
    ...
    return IgxBollingerBandsOverlayModule;
}());
export { IgxBollingerBandsOverlayModule };
//# sourceMappingURL=igx-bollinger-bands-overlay-module.js.map