...
var IgxPercentagePriceOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxPercentagePriceOscillatorIndicatorDynamicModule() {
    ...
    IgxPercentagePriceOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPercentagePriceOscillatorIndicatorDynamicModule;
}());
export { IgxPercentagePriceOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-percentage-price-oscillator-indicator-dynamic-module.js.map