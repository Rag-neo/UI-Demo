...
var IgxCategoryDateTimeXAxisDynamicModule = /** @class */ (function () {
    function IgxCategoryDateTimeXAxisDynamicModule() {
    ...
    IgxCategoryDateTimeXAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCategoryDateTimeXAxisDynamicModule;
}());
export { IgxCategoryDateTimeXAxisDynamicModule };
//# sourceMappingURL=igx-category-date-time-x-axis-dynamic-module.js.map