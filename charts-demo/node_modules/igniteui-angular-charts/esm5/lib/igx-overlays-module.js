...
var IgxOverlaysModule = /** @class */ (function () {
    function IgxOverlaysModule() {
    }
    IgxOverlaysModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxOverlaysModule;
}());
export { IgxOverlaysModule };
//# sourceMappingURL=igx-overlays-module.js.map