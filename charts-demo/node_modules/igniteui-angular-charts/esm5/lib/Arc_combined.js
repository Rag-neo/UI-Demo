...
var Arc = /** @class */ (function (_super) {
    ...
    Arc.prototype.av = function () {
        return new ArcView(this);
    };
    Arc.prototype.fq = function (a) {
        _super.prototype.fq.call(this, a);
        this.h4 = a;
    };
    Object.defineProperty(Arc.prototype, "h6", {
        get: function () {
            return this.h5;
        },
        set: function (a) {
            var b = this.h5;
            this.h5 = a;
            this.h4.b6(b, this.h5);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Arc.prototype, "h9", {
        get: function () {
            if (this.h6 != null) {
                return this.h6.i;
            }
    ...
    Arc.prototype.fp = function (a, b) {
        _super.prototype.fp.call(this, a, b);
        if (this.h6 != null) {
            this.h6.c.ax.bu(a, b);
        }
    };
    Arc.prototype.e4 = function (a, b) {
        if (this.h6 != null && this.h6.d != null) {
            _super.prototype.e4.call(this, a, b);
            var c = this.h7(a);
            if (c != null) {
                this.h6.d.bj(c, b);
            }
    ...
    Arc.prototype.f4 = function (a, b) {
        if (this.h6 != null && this.h6.d != null) {
            _super.prototype.f4.call(this, a, b);
            var c = this.h7(a);
            if (c != null) {
                this.h6.d.b5(c, b);
            }
    ...
    Arc.prototype.h7 = function (a) {
        var e_1, _a;
        try {
            for (var _b = tslib_1.__values(fromEnum(this.h3.g)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                if (b.b == a) {
                    return b;
                }
    ...
    Arc.prototype.ft = function () {
        ...
        for (var e = 0; e < a; e++) {
            ...
            if (this.hr == 1) {
                d += PieChartBase.c0(Math.abs(g) * this.ia / this.c2);
            }
            else {
                d -= PieChartBase.c0(Math.abs(g) * this.ia / this.c2);
            }
    ...
    Arc.prototype.f0 = function () {
        ...
        if (this.bi == null || this.bi.count == 0 || ((this.h6 != null && this.h6.c != null) && (this.h6.d != null && !this.h6.d.series.contains(this.h6.c)))) {
            a.clearLegendItemsForSeries(this.h6.c);
            return;
        }
        ...
        var _loop_1 = function (b) {
            ...
            var d = this_1.c6(b);
            var e = b.b0;
            var f = b.isOthersSlice ? this_1.eg : (this_1.bj != null && this_1.bj.count > 0) ? this_1.bj.item(this_1.ca._inner[b.a5]) : null;
            f = (f == null && this_1.bi.count > 0) ? this_1.bi.item(this_1.ca._inner[b.a5]) : f;
            c.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this.h6.c;
                $ret.slice = b;
                $ret.item = b.dataContext;
                $ret.itemBrush = e;
                $ret.legendLabel = f != null ? f.toString() : null;
                $ret.itemLabel = d != null ? d.toString() : null;
                $ret.percentValue = _this.cs(b);
            ...
            if (this_1.ba != null && !g.isOthersSlice) {
                var i = this_1.ba.i(g);
                g.legendLabel = i;
            }
            if (this_1.bb != null && g.isOthersSlice) {
                var j = this_1.bb.i(g);
                g.legendLabel = j;
            }
        ...
        if (a.isItemwise) {
            var k = a;
            k.createLegendItemsInsert(this.b7, this.h6.c);
        }
    };
    Arc.prototype.fu = function (a, b, c, d) {
        _super.prototype.fu.call(this, a, b, c, d);
        switch (b) {
            case Arc.$$p[0]:
                this.h8 = d;
                this.ft();
            ...
            case "Legend":
                ...
                if (e != null && this.h6 != null && this.h6.c != null) {
                    e.clearLegendItemsForSeries(this.h6.c);
                }
                break;
        }
    };
    Arc.prototype.ib = function () {
        return this.aw.ac();
    };
    Arc.$t = markType(Arc, 'Arc', PieChartBase.$);
    Arc.$$p = markDep(DependencyProperty, PropertyMetadata, Arc, 'fw', ['EndAngle:ia:id', [1, 360]]);
    return Arc;
}(PieChartBase));
export { Arc };
/**
...
var ArcItem = /** @class */ (function (_super) {
    ...
    ArcItem.prototype.o = function (a, b) {
        ...
        var o = e.count;
        var p = f.count > 0;
        var q = PieChartBase.c0(a);
        var r = PieChartBase.c0(a);
        if (p) {
            o++;
        }
        var _loop_2 = function (s) {
            ...
            var v = 1;
            if (v == 1) {
                r += PieChartBase.c0(Math.abs(u) * b / c);
            }
            else {
                r -= PieChartBase.c0(Math.abs(u) * b / c);
            }
...
var RingSeriesBase = /** @class */ (function (_super) {
    ...
    function RingSeriesBase() {
        ...
        _this.aw = null;
        _this.c6 = null;
        _this.ee = { $type: Point_$type, x: 0, y: 0 };
        _this.as = function (a, b) { return _this.c1(a, b.propertyName, b.oldValue, b.newValue); };
        _this.propertyUpdated = delegateCombine(_this.propertyUpdated, _this.as);
        _this.aw = _this.av();
        _this.cy(_this.aw);
        _this.aw.k();
        _this.a9 = function (a, b) { return _this.cs(b.action, b.position, b.count, b.propertyName); };
        return _this;
    }
    RingSeriesBase.prototype.c3 = function (a, b, c) {
    ...
    Object.defineProperty(RingSeriesBase.prototype, "ei", {
        get: function () {
            if (this.eh != null) {
                return this.eh;
            }
        ...
        set: function (a) {
            var b = this.ei;
            if (this.eh != null && a != this.eh) {
                a = this.eh;
            }
            this.c3("SelectedStyleResolved", b, a);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RingSeriesBase.prototype, "cl", {
        get: function () {
            return this.bb;
        },
        set: function (a) {
            var b = this.bb;
            this.bb = a;
            this.c3("TextStyle", b, a);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RingSeriesBase.prototype, "c7", {
        get: function () {
            return typeCast(DataTemplate.$, this.c(RingSeriesBase.dl));
        },
        set: function (a) {
            this.h(RingSeriesBase.dl, a);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RingSeriesBase.prototype, "a1", {
        get: function () {
            return this.c(RingSeriesBase.dc);
        },
        set: function (a) {
            this.a0 = true;
            this.h(RingSeriesBase.dc, a);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RingSeriesBase.prototype, "a2", {
        get: function () {
            if (!this.a0) {
                return this.ax.ax;
            }
    ...
    RingSeriesBase.prototype.c1 = function (a, b, c, d) {
        ...
        if (b == RingSeriesBase.$$p[1]) {
            if (typeCast(FastItemsSource.$, c) != null) {
                ...
                e.event = delegateRemove(e.event, this.a9);
                this.az = false;
            }
            if (typeCast(FastItemsSource.$, d) != null) {
                var f = (typeCast(FastItemsSource.$, d));
                f.event = delegateCombine(f.event, this.a9);
                this.az = true;
            }
            this.c0();
        }
    ...
    RingSeriesBase.prototype.cs = function (a, b, c, d) {
        this.c0();
    };
    RingSeriesBase.prototype.av = function () {
        return new RingSeriesBaseView(this);
    };
    RingSeriesBase.prototype.cy = function (a) {
    };
    RingSeriesBase.prototype.c2 = function (a) {
        this.aw.n(a);
    };
    RingSeriesBase.prototype.cr = function () {
        if (this.aw != null) {
            this.aw.i();
        }
    };
    RingSeriesBase.prototype.cv = function (a, b) {
        this.ct(new NotifyCollectionChangedEventArgs(1, 0, b, a));
    };
    RingSeriesBase.prototype.cx = function (a, b, c) {
        this.ct(new NotifyCollectionChangedEventArgs(2, 2, c, b, a));
    };
    RingSeriesBase.prototype.cu = function () {
        this.ct(new NotifyCollectionChangedEventArgs(0, 4));
    };
    RingSeriesBase.prototype.cw = function (a, b) {
        this.ct(new NotifyCollectionChangedEventArgs(1, 1, b, a));
    };
    RingSeriesBase.prototype.ct = function (a) {
        if (this.ay != null) {
    ...
    RingSeriesBase.dl = DependencyProperty.i("LabelTemplate", DataTemplate.$, RingSeriesBase.$, new PropertyMetadata(2, null, function (a, b) { return (typeCast(RingSeriesBase.$, a)).c3("LabelTemplate", b.oldValue, b.newValue); }));
    RingSeriesBase.dc = DependencyProperty.i("IsSurfaceInteractionDisabled", Boolean_$type, RingSeriesBase.$, new PropertyMetadata(2, false, function (a, b) { return a.c3("IsSurfaceInteractionDisabled", b.oldValue, b.newValue); }));
    RingSeriesBase.$$p = markDep(DependencyProperty, PropertyMetadata, RingSeriesBase, 'c3', ['Brushes:ak:c8', [BrushCollection.$, null], 'FastItemsSource:ay:c9', [FastItemsSource.$], 'FormatLabel:aq:da', [Delegate_$type], 'FormatLegendLabel:ar:db', [Delegate_$type], 'ItemsSource::dd', [IEnumerable_$type, null], 'LabelExtent:a4:de', [1, 10], 'LabelFormat:bj:df', [2, null], 'LabelFormatSpecifiers:ag:dg', [Array_$type, null], 'LabelInnerColor:ec:dh', [Brush.$, null], 'LabelMemberPath:bn:di', [2], 'LabelOuterColor:ed:dj', [Brush.$, null], 'LabelsPosition:an:dk', [LabelsPosition_$type, enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:a5:dm', [1, 6], 'LeaderLineStyle:ef:dn', [Style.$, null], 'LeaderLineType:ao:dp', [LeaderLineType_$type, enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:ek:dq', [Visibility_$type, enumGetBox(Visibility_$type, 0)], 'LegendItemBadgeTemplate::dr', [DataTemplate.$, null], 'LegendItemTemplate::ds', [DataTemplate.$, null], 'LegendLabelFormat:by:dt', [2, null], 'LegendLabelFormatSpecifiers:ah:du', [Array_$type, null], 'LegendLabelMemberPath:b1:dv', [2], 'LegendOthersLabelFormat:b3:dw', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:dx', [Array_$type, null], 'Legend::dy', [IChartLegend_$type, null], 'OthersCategoryStyle:eg:dz', [Style.$, null], 'OthersCategoryText:b8:d0', [2, "Others"], 'OthersCategoryThreshold:a6:d1', [1, 3], 'OthersCategoryType:ap:d2', [OthersCategoryType_$type, enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:cc:d3', [2, null], 'OthersLabelFormatSpecifiers:aj:d4', [Array_$type, null], 'Outlines:al:d5', [BrushCollection.$, null], 'RadiusFactor:a7:d6', [1, 0.9], 'SelectedStyle:eh:d7', [Style.$, null], 'StartAngle:a8:d8', [1, 0], 'ToolTip::d9', [4, null], 'ToolTipStyle:ej:ea', [Style.$, null], 'ValueMemberPath:cp:eb', [2, null]]);
...
var Ring = /** @class */ (function (_super) {
    ...
    Ring.prototype.f = function () {
        if (this.ringControl != null && this.ringControl.ak.d()) {
            ...
            a = this.p.x - this.c.ee.x;
            b = this.p.y - this.c.ee.y;
    ...
    RingControl.prototype.an = function () {
        ...
        try {
            for (var _b = tslib_1.__values(fromEnum(this.ao)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if ((d.width != this.ai.q.width || d.height != this.ai.q.height) && d.aw.r()) {
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    b = _b.value;
                    if (!PieChartBase.b6(a, b.itemsSource)) return [3 /*break*/, 3];
                    return [4 /*yield*/, b];
                case 2:
                    _d.sent();
                    _d.label = 3;
...
var RingControlView = /** @class */ (function (_super) {
    ...
    RingControlView.prototype.a = function () {
        ...
        a.b3 = true;
        a.cz = this.b.al.a7;
        a.bx = this.b.al.ax.av;
        a.by = this.b.al.ax.aw;
        a.ay = this.b.al.ar;
        a.d9 = this.b.al.b1;
        a.cl = this.b.al.ax.a1;
        return a;
    };
    ...
    RingControlView.prototype.ab = function (a) {
        this.k(a, a.ib().rootWrapper);
        a.fg(a.width, a.height);
    };
        ...
        switch (b.propertyName) {
            case "LabelExtent":
                for (var c = 0; c < this.f.count; c++) {
                    this.f._inner[c].cu = b.newValue;
                }
                break;
            case "LabelMemberPath":
                for (var d = 0; d < this.f.count; d++) {
                    this.f._inner[d].du = b.newValue;
                }
                break;
            case "LabelsPosition":
                for (var e = 0; e < this.f.count; e++) {
                    this.f._inner[e].as = EnumUtil.getEnumValue(LabelsPosition_$type, b.newValue);
                }
                break;
            case "LabelTemplate":
                for (var f = 0; f < this.f.count; f++) {
                    this.f._inner[f].ge = b.newValue;
                }
                break;
            case "ValueMemberPath":
                for (var g = 0; g < this.f.count; g++) {
                    this.f._inner[g].e0 = b.newValue;
                }
                break;
            case "ToolTip":
                for (var h = 0; h < this.f.count; h++) {
                    this.f._inner[h].c8 = b.newValue;
                }
                break;
            case "LeaderLineVisibility":
                for (var i = 0; i < this.f.count; i++) {
                    this.f._inner[i].h2 = EnumUtil.getEnumValue(Visibility_$type, b.newValue);
                }
                break;
            case "LeaderLineStyle":
                for (var j = 0; j < this.f.count; j++) {
                    this.f._inner[j].hy = b.newValue;
                }
                break;
            case "LeaderLineType":
                for (var k = 0; k < this.f.count; k++) {
                    this.f._inner[k].at = EnumUtil.getEnumValue(LeaderLineType_$type, b.newValue);
                }
                break;
            case "LeaderLineMargin":
                for (var l = 0; l < this.f.count; l++) {
                    this.f._inner[l].cv = b.newValue;
                }
                break;
            case "OthersCategoryThreshold":
                for (var m = 0; m < this.f.count; m++) {
                    this.f._inner[m].cw = b.newValue;
                }
                break;
            case "OthersCategoryType":
                for (var n = 0; n < this.f.count; n++) {
                    this.f._inner[n].au = EnumUtil.getEnumValue(OthersCategoryType_$type, b.newValue);
                }
                break;
            case "OthersCategoryText":
                for (var o = 0; o < this.f.count; o++) {
                    this.f._inner[o].eg = b.newValue;
                }
                break;
            case "OthersCategoryStyle":
                for (var p = 0; p < this.f.count; p++) {
                    this.f._inner[p].hz = b.newValue;
                }
                break;
            case "Legend":
            ...
            case "Outlines":
                for (var t = 0; t < this.f.count; t++) {
                    this.f._inner[t].al = b.newValue;
                }
                break;
            case "Brushes":
                for (var u = 0; u < this.f.count; u++) {
                    this.f._inner[u].ak = b.newValue;
                }
                break;
            case "SelectedStyle":
                for (var v = 0; v < this.f.count; v++) {
                    this.f._inner[v].h0 = b.newValue;
                }
                break;
            case "SelectedStyleResolved":
                for (var w = 0; w < this.f.count; w++) {
                    this.f._inner[w].h0 = b.newValue;
                }
                break;
            case "RadiusFactor":
                for (var x = 0; x < this.f.count; x++) {
                    this.f._inner[x].cz = b.newValue;
                }
                break;
        }
    };
...
var RingSeriesBaseView = /** @class */ (function (_super) {
    ...
    RingSeriesBaseView.prototype.j = function (a, b, c, d, e) {
        ...
        var i = BrushUtil.e("doughnut", a, b, c, g);
        b = i.p2;
        c = i.p3;
        d = new Brush();
    ...
    RingSeriesBaseView.prototype.m = function (a, b) {
        this.c.n = a;
        this.c.o = b;
        this.c.ee = { $type: Point_$type, x: a, y: b };
    };
...
var XamDoughnutChartView = /** @class */ (function (_super) {
    ...
    XamDoughnutChartView.prototype.o = function (a) {
        ...
        for (var b = 0; b < this.a.series.count; b++) {
            ...
            a.series._inner[b].labelExtent = this.a.series._inner[b].a4;
            a.series._inner[b].leaderLineMargin = this.a.series._inner[b].a5;
            ...
            a.series._inner[b].leaderLineVisibility = this.a.series._inner[b].ek == 0;
