...
var IgxPriceChannelOverlayDynamicModule = /** @class */ (function () {
    function IgxPriceChannelOverlayDynamicModule() {
    ...
    IgxPriceChannelOverlayDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPriceChannelOverlayDynamicModule;
}());
export { IgxPriceChannelOverlayDynamicModule };
//# sourceMappingURL=igx-price-channel-overlay-dynamic-module.js.map