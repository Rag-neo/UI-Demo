...
var IgxSparklineModule = /** @class */ (function () {
    function IgxSparklineModule() {
    }
    IgxSparklineModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSparklineModule;
}());
export { IgxSparklineModule };
//# sourceMappingURL=igx-sparkline-module.js.map