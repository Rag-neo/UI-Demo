...
var IgxRelativeStrengthIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxRelativeStrengthIndexIndicatorDynamicModule() {
    ...
    IgxRelativeStrengthIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRelativeStrengthIndexIndicatorDynamicModule;
}());
export { IgxRelativeStrengthIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-relative-strength-index-indicator-dynamic-module.js.map