...
* ```
*/
export var IgxTimeAxisBaseComponent_PROVIDERS = [{ provide: IgxCategoryAxisBaseComponent, useExisting: forwardRef(function () { return IgxTimeAxisBaseComponent; }) }, { provide: IgxAxisComponent, useExisting: forwardRef(function () { return IgxTimeAxisBaseComponent; }) }];
var IgxTimeAxisBaseComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxTimeAxisBaseComponent, _super);
