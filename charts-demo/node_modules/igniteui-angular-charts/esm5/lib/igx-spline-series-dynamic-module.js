...
var IgxSplineSeriesDynamicModule = /** @class */ (function () {
    function IgxSplineSeriesDynamicModule() {
    ...
    IgxSplineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSplineSeriesDynamicModule;
}());
export { IgxSplineSeriesDynamicModule };
//# sourceMappingURL=igx-spline-series-dynamic-module.js.map