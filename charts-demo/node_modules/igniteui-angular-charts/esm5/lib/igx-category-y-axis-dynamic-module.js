...
var IgxCategoryYAxisDynamicModule = /** @class */ (function () {
    function IgxCategoryYAxisDynamicModule() {
    ...
    IgxCategoryYAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCategoryYAxisDynamicModule;
}());
export { IgxCategoryYAxisDynamicModule };
//# sourceMappingURL=igx-category-y-axis-dynamic-module.js.map