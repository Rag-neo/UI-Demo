...
import { typeCast, Number_$type, Point_$type, fromEnum, runOn, delegateRemove, delegateCombine, markType, markDep } from "igniteui-angular-core";
...
var ScatterContourSeries = /** @class */ (function (_super) {
    ...
    function ScatterContourSeries() {
        ...
        _this.nj = new LinearContourValueResolver();
        return _this;
    }
    ...
    Object.defineProperty(ScatterContourSeries.prototype, "nn", {
        get: function () {
            return this.nm;
        },
        set: function (a) {
    ...
    ScatterContourSeries.prototype.i0 = function (a, b, c, d) {
    ...
    ScatterContourSeries.prototype.hw = function (a, b) {
        _super.prototype.hw.call(this, a, b);
        if (a) {
            b.b0(a);
        }
    };
    ScatterContourSeries.prototype.jf = function (a) {
        _super.prototype.jf.call(this, a);
        this.nt(this.bi);
    };
    ScatterContourSeries.prototype.jd = function (a, b, c, d, e) {
    ...
    ScatterContourSeries.prototype.nt = function (a) {
        var e_1, _a;
        if (this.cc(a)) {
            return;
        }
        ...
        c = e.p0;
        b = e.p1;
        var f = new ScalerParams(1, b, c, this.l1.ca);
        f.c = this.getEffectiveViewport1(a);
        var g = new ScalerParams(1, b, c, this.l2.ca);
    ...
    Object.defineProperty(ScatterContourSeries.prototype, "nj", {
        get: function () {
            return this.ni;
        },
        set: function (a) {
    ...
    ScatterContourSeries.prototype.nu = function (a, b) {
        this.je(false);
    };
    ScatterContourSeries.prototype.dw = function (a, b, c) {
        return _super.prototype.dw.call(this, a, b, c) && this.nj != null && this.me != null && this.mf != null && this.mb != null && this.mc != null && this.md != null && this.me.count > 0 && this.mf.count > 0 && this.mb.count > 0 && this.mc.count > 0 && this.md.count > 0;
    };
    ScatterContourSeries.prototype.ar = function (a, b) {
        var c = this.nk.b4(a, b);
        if (c != null) {
    ...
    ScatterContourSeries.$$p = markDep(DependencyProperty, PropertyMetadata, ScatterContourSeries, 'raisePropertyChanged', ['FillScale:nl:nv', [ValueBrushScale.$, null], 'ValueMemberPath:nq:nw', [2, null]]);
...
var ScatterContourSeriesView = /** @class */ (function (_super) {
    ...
    ScatterContourSeriesView.prototype.bz = function (a, b) {
        ...
        for (var e = 0; e < b.length; e++) {
            ...
            if (d != null) {
                var m = d.getBrushByValue(f, this.bv.nn);
                if (m == null) {
                    m = this.e.k4;
                }
                this.bx.add(m);
