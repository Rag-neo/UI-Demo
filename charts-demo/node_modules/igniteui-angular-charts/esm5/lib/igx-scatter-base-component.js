...
*/
export var IgxScatterBaseComponent_PROVIDERS = [{ provide: IgxMarkerSeriesComponent, useExisting: forwardRef(function () { return IgxScatterBaseComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxScatterBaseComponent; }) }];
var IgxScatterBaseComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxScatterBaseComponent, _super);
