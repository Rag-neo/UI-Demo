...
var IgxStackedLineSeriesDynamicModule = /** @class */ (function () {
    function IgxStackedLineSeriesDynamicModule() {
    ...
    IgxStackedLineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStackedLineSeriesDynamicModule;
}());
export { IgxStackedLineSeriesDynamicModule };
//# sourceMappingURL=igx-stacked-line-series-dynamic-module.js.map