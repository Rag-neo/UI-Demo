...
var IgxScatterPolylineSeriesDynamicModule = /** @class */ (function () {
    function IgxScatterPolylineSeriesDynamicModule() {
    ...
    IgxScatterPolylineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxScatterPolylineSeriesDynamicModule;
}());
export { IgxScatterPolylineSeriesDynamicModule };
//# sourceMappingURL=igx-scatter-polyline-series-dynamic-module.js.map