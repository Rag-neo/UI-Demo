...
var IgxMoneyFlowIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxMoneyFlowIndexIndicatorDynamicModule() {
    ...
    IgxMoneyFlowIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxMoneyFlowIndexIndicatorDynamicModule;
}());
export { IgxMoneyFlowIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-money-flow-index-indicator-dynamic-module.js.map