...
var IgxScatterPolygonSeriesDynamicModule = /** @class */ (function () {
    function IgxScatterPolygonSeriesDynamicModule() {
    ...
    IgxScatterPolygonSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxScatterPolygonSeriesDynamicModule;
}());
export { IgxScatterPolygonSeriesDynamicModule };
//# sourceMappingURL=igx-scatter-polygon-series-dynamic-module.js.map