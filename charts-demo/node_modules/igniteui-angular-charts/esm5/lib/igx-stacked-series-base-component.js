...
*/
export var IgxStackedSeriesBaseComponent_PROVIDERS = [];
var IgxStackedSeriesBaseComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxStackedSeriesBaseComponent, _super);
