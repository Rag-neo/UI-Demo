...
var IgxScatterLineSeriesDynamicModule = /** @class */ (function () {
    function IgxScatterLineSeriesDynamicModule() {
    ...
    IgxScatterLineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxScatterLineSeriesDynamicModule;
}());
export { IgxScatterLineSeriesDynamicModule };
//# sourceMappingURL=igx-scatter-line-series-dynamic-module.js.map