...
import { IgxChaikinOscillatorIndicatorModule } from './igx-chaikin-oscillator-indicator-module';
...
import { IgxNegativeVolumeIndexIndicatorModule } from './igx-negative-volume-index-indicator-module';
...
import { IgxPositiveVolumeIndexIndicatorModule } from './igx-positive-volume-index-indicator-module';
import { IgxPriceVolumeTrendIndicatorModule } from './igx-price-volume-trend-indicator-module';
...
import { IgxStandardDeviationIndicatorModule } from './igx-standard-deviation-indicator-module';
import { IgxStochRSIIndicatorModule } from './igx-stoch-rsi-indicator-module';
import { IgxTRIXIndicatorModule } from './igx-trix-indicator-module';
import { IgxTypicalPriceIndicatorModule } from './igx-typical-price-indicator-module';
...
import { IgxCustomIndicatorModule } from './igx-custom-indicator-module';
var IgxIndicatorsModule = /** @class */ (function () {
    function IgxIndicatorsModule() {
    }
    IgxIndicatorsModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
            exports: [IgxAbsoluteVolumeOscillatorIndicatorModule,
                IgxAccumulationDistributionIndicatorModule,
    ...
    return IgxIndicatorsModule;
}());
export { IgxIndicatorsModule };
//# sourceMappingURL=igx-indicators-module.js.map