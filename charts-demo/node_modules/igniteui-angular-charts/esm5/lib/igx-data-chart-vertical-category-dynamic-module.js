...
var IgxDataChartVerticalCategoryDynamicModule = /** @class */ (function () {
    function IgxDataChartVerticalCategoryDynamicModule() {
    }
    IgxDataChartVerticalCategoryDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxDataChartVerticalCategoryDynamicModule);
    return IgxDataChartVerticalCategoryDynamicModule;
}());
export { IgxDataChartVerticalCategoryDynamicModule };
//# sourceMappingURL=igx-data-chart-vertical-category-dynamic-module.js.map