...
var IgxValueBrushScaleDynamicModule = /** @class */ (function () {
    function IgxValueBrushScaleDynamicModule() {
    ...
    IgxValueBrushScaleDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxValueBrushScaleDynamicModule;
}());
export { IgxValueBrushScaleDynamicModule };
//# sourceMappingURL=igx-value-brush-scale-dynamic-module.js.map