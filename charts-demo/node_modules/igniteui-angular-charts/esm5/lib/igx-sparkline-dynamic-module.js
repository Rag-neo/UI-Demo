...
var IgxSparklineDynamicModule = /** @class */ (function () {
    function IgxSparklineDynamicModule() {
    }
    IgxSparklineDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxSparklineDynamicModule);
    return IgxSparklineDynamicModule;
}());
export { IgxSparklineDynamicModule };
//# sourceMappingURL=igx-sparkline-dynamic-module.js.map