...
var IgxDataChartRadialModule = /** @class */ (function () {
    function IgxDataChartRadialModule() {
    }
    IgxDataChartRadialModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartRadialModule;
}());
export { IgxDataChartRadialModule };
//# sourceMappingURL=igx-data-chart-radial-module.js.map