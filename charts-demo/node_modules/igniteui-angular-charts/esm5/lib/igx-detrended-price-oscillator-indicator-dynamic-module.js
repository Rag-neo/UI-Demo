...
var IgxDetrendedPriceOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxDetrendedPriceOscillatorIndicatorDynamicModule() {
    ...
    IgxDetrendedPriceOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDetrendedPriceOscillatorIndicatorDynamicModule;
}());
export { IgxDetrendedPriceOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-detrended-price-oscillator-indicator-dynamic-module.js.map