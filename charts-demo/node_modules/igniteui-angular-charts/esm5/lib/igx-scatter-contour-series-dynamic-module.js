...
var IgxScatterContourSeriesDynamicModule = /** @class */ (function () {
    function IgxScatterContourSeriesDynamicModule() {
    ...
    IgxScatterContourSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxScatterContourSeriesDynamicModule;
}());
export { IgxScatterContourSeriesDynamicModule };
//# sourceMappingURL=igx-scatter-contour-series-dynamic-module.js.map