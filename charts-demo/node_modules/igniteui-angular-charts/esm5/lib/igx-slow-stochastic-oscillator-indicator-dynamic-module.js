...
var IgxSlowStochasticOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxSlowStochasticOscillatorIndicatorDynamicModule() {
    ...
    IgxSlowStochasticOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSlowStochasticOscillatorIndicatorDynamicModule;
}());
export { IgxSlowStochasticOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-slow-stochastic-oscillator-indicator-dynamic-module.js.map