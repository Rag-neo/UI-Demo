...
var IgxUltimateOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxUltimateOscillatorIndicatorDynamicModule() {
    ...
    IgxUltimateOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxUltimateOscillatorIndicatorDynamicModule;
}());
export { IgxUltimateOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-ultimate-oscillator-indicator-dynamic-module.js.map