...
var RangeCategorySeries = /** @class */ (function (_super) {
    ...
    function RangeCategorySeries() {
        ...
        _this.o2 = null;
        _this.oz = null;
        _this.RangeFramePreparer = new RangeCategoryFramePreparer(1, _this, _this.o1, _this, _this, _this.o1.cn);
        return _this;
    }
    ...
    RangeCategorySeries.prototype.iv = function (a) {
    ...
    RangeCategorySeries.prototype.nk = function () {
        return 11;
    };
    RangeCategorySeries.prototype.os = function (a, b) {
        _super.prototype.os.call(this, a, b);
        b.b0 = true;
        CategoryMarkerManager.b(this, a.m, b.cq, this.l6);
        this.om(b, a);
    };
    RangeCategorySeries.prototype.pc = function (a, b, c, d, e, f) {
    ...
    RangeCategorySeries.prototype.c9 = function (a) {
        ...
        var h = this.lt(this.bi);
        var i;
        if (f != null) {
            var j = new ScalerParams(0, b, b, f.ca, h);
            i = f.dy(e, j);
        }
        else {
            i = NaN;
        ...
        if (e >= 0 && Rect.l_op_Inequality(c, null) && Rect.l_op_Inequality(d, null)) {
            ...
            if (g != null && this.highColumn != null && e < this.highColumn.count) {
                var l = new ScalerParams(0, b, b, g.ca, h);
                l.b = this.eh();
                var m = g.dy(this.highColumn.item(e), l);
                var n = g.dy(this.lowColumn.item(e), l);
    ...
    RangeCategorySeries.prototype.i0 = function (a, b, c, d) {
    ...
    RangeCategorySeries.prototype.hz = function (a, b, c, d) {
    ...
    RangeCategorySeries.prototype.op = function (a, b) {
    ...
    RangeCategorySeries.prototype.jg = function (a, b) {
        var c = this.dl;
    ...
    RangeCategorySeries.prototype.jd = function (a, b, c, d, e) {
