...
var IgxMassIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxMassIndexIndicatorDynamicModule() {
    ...
    IgxMassIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxMassIndexIndicatorDynamicModule;
}());
export { IgxMassIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-mass-index-indicator-dynamic-module.js.map