...
var IgxAverageDirectionalIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxAverageDirectionalIndexIndicatorDynamicModule() {
    ...
    IgxAverageDirectionalIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAverageDirectionalIndexIndicatorDynamicModule;
}());
export { IgxAverageDirectionalIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-average-directional-index-indicator-dynamic-module.js.map