...
var IgxMovingAverageConvergenceDivergenceIndicatorDynamicModule = /** @class */ (function () {
    function IgxMovingAverageConvergenceDivergenceIndicatorDynamicModule() {
    ...
    IgxMovingAverageConvergenceDivergenceIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxMovingAverageConvergenceDivergenceIndicatorDynamicModule;
}());
export { IgxMovingAverageConvergenceDivergenceIndicatorDynamicModule };
//# sourceMappingURL=igx-moving-average-convergence-divergence-indicator-dynamic-module.js.map