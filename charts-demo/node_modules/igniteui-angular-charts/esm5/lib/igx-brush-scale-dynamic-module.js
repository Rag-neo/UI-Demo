...
var IgxBrushScaleDynamicModule = /** @class */ (function () {
    function IgxBrushScaleDynamicModule() {
    ...
    IgxBrushScaleDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxBrushScaleDynamicModule);
    return IgxBrushScaleDynamicModule;
}());
export { IgxBrushScaleDynamicModule };
//# sourceMappingURL=igx-brush-scale-dynamic-module.js.map