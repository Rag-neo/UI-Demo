...
var IgxForceIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxForceIndexIndicatorDynamicModule() {
    ...
    IgxForceIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxForceIndexIndicatorDynamicModule;
}());
export { IgxForceIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-force-index-indicator-dynamic-module.js.map