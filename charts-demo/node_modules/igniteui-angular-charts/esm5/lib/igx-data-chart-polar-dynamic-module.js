...
var IgxDataChartPolarDynamicModule = /** @class */ (function () {
    function IgxDataChartPolarDynamicModule() {
    }
    IgxDataChartPolarDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxDataChartPolarDynamicModule);
    return IgxDataChartPolarDynamicModule;
}());
export { IgxDataChartPolarDynamicModule };
//# sourceMappingURL=igx-data-chart-polar-dynamic-module.js.map