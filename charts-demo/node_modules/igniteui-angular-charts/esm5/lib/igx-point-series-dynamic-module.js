...
var IgxPointSeriesDynamicModule = /** @class */ (function () {
    function IgxPointSeriesDynamicModule() {
    ...
    IgxPointSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPointSeriesDynamicModule;
}());
export { IgxPointSeriesDynamicModule };
//# sourceMappingURL=igx-point-series-dynamic-module.js.map