...
var IgxAccumulationDistributionIndicatorDynamicModule = /** @class */ (function () {
    function IgxAccumulationDistributionIndicatorDynamicModule() {
    ...
    IgxAccumulationDistributionIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAccumulationDistributionIndicatorDynamicModule;
}());
export { IgxAccumulationDistributionIndicatorDynamicModule };
//# sourceMappingURL=igx-accumulation-distribution-indicator-dynamic-module.js.map