...
var IgxValueOverlayDynamicModule = /** @class */ (function () {
    function IgxValueOverlayDynamicModule() {
    ...
    IgxValueOverlayDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxValueOverlayDynamicModule);
    return IgxValueOverlayDynamicModule;
}());
export { IgxValueOverlayDynamicModule };
//# sourceMappingURL=igx-value-overlay-dynamic-module.js.map