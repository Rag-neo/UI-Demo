...
var IgxCommodityChannelIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxCommodityChannelIndexIndicatorDynamicModule() {
    ...
    IgxCommodityChannelIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCommodityChannelIndexIndicatorDynamicModule;
}());
export { IgxCommodityChannelIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-commodity-channel-index-indicator-dynamic-module.js.map