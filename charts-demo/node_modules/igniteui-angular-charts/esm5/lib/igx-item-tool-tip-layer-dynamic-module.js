...
var IgxItemToolTipLayerDynamicModule = /** @class */ (function () {
    function IgxItemToolTipLayerDynamicModule() {
    ...
    IgxItemToolTipLayerDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxItemToolTipLayerDynamicModule;
}());
export { IgxItemToolTipLayerDynamicModule };
//# sourceMappingURL=igx-item-tool-tip-layer-dynamic-module.js.map