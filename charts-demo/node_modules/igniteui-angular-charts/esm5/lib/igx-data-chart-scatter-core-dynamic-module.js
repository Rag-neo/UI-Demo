...
var IgxDataChartScatterCoreDynamicModule = /** @class */ (function () {
    function IgxDataChartScatterCoreDynamicModule() {
    }
    IgxDataChartScatterCoreDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartScatterCoreDynamicModule;
}());
export { IgxDataChartScatterCoreDynamicModule };
//# sourceMappingURL=igx-data-chart-scatter-core-dynamic-module.js.map