...
var IgxTreemapNodeStyleMappingDynamicModule = /** @class */ (function () {
    function IgxTreemapNodeStyleMappingDynamicModule() {
    ...
    IgxTreemapNodeStyleMappingDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxTreemapNodeStyleMappingDynamicModule;
}());
export { IgxTreemapNodeStyleMappingDynamicModule };
//# sourceMappingURL=igx-treemap-node-style-mapping-dynamic-module.js.map