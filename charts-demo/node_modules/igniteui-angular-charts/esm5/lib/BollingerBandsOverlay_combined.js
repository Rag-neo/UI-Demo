...
var BollingerBandsOverlay = /** @class */ (function (_super) {
    ...
    function BollingerBandsOverlay() {
        ...
        _this.pq = new List$1(Number_$type, 0);
        _this.ab = BollingerBandsOverlay.$;
        _this.mc = new CategoryFrame(4);
        _this.me = new CategoryFrame(4);
        _this.mb = new CategoryFrame(4);
        return _this;
    }
    BollingerBandsOverlay.prototype.i0 = function (a, b, c, d) {
    ...
    BollingerBandsOverlay.prototype.pk = function () {
        this.pp.clear();
        this.pq.clear();
        var a = getEnumerator(TrendCalculators.e(new SafeEnumerable(this.nr), this.pu));
        var b = getEnumerator(TrendCalculators.f(new SafeEnumerable(this.nr), this.pu));
    ...
    BollingerBandsOverlay.prototype.an = function (a) {
        ...
        var b = new AxisRange(this.ps, this.pr);
        return b;
    };
    BollingerBandsOverlay.prototype.o0 = function (a, b) {
        ...
        a.m.clear();
        a.p.clear();
        var j = typeCast(ISortingAxis_$type, this.l9);
        ...
        i.b = this.eh();
        var l = this.l9.d1(2, h) - this.l9.d1(1, h);
    ...
    BollingerBandsOverlay.prototype.hw = function (a, b) {
    ...
    BollingerBandsOverlay.prototype.o2 = function (a, b) {
        ...
        if (k) {
            var o = new ScalerParams(0, b.bs, b.br, this.l9.ca, d);
    ...
    BollingerBandsOverlay.prototype.iv = function (a) {
        _super.prototype.iv.call(this, a);
        this.po = typeCast(BollingerBandsOverlayView.$, a);
    };
    BollingerBandsOverlay.prototype.n9 = function () {
        return 3;
    };
    ...
    BollingerBandsOverlay.$$p = markDep(DependencyProperty, PropertyMetadata, BollingerBandsOverlay, 'raisePropertyChanged', ['Multiplier:pt:px', [1, 2], 'Period:pu:py', [1, 14]]);
