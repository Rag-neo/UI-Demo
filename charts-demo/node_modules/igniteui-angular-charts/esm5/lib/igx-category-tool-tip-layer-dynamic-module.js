...
var IgxCategoryToolTipLayerDynamicModule = /** @class */ (function () {
    function IgxCategoryToolTipLayerDynamicModule() {
    ...
    IgxCategoryToolTipLayerDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCategoryToolTipLayerDynamicModule;
}());
export { IgxCategoryToolTipLayerDynamicModule };
//# sourceMappingURL=igx-category-tool-tip-layer-dynamic-module.js.map