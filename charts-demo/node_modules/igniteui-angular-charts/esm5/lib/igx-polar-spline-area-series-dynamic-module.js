...
var IgxPolarSplineAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxPolarSplineAreaSeriesDynamicModule() {
    ...
    IgxPolarSplineAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPolarSplineAreaSeriesDynamicModule;
}());
export { IgxPolarSplineAreaSeriesDynamicModule };
//# sourceMappingURL=igx-polar-spline-area-series-dynamic-module.js.map