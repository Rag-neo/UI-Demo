...
var IgxCalloutLayerDynamicModule = /** @class */ (function () {
    function IgxCalloutLayerDynamicModule() {
    ...
    IgxCalloutLayerDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCalloutLayerDynamicModule;
}());
export { IgxCalloutLayerDynamicModule };
//# sourceMappingURL=igx-callout-layer-dynamic-module.js.map