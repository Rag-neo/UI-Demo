...
var IgxFinancialChartDefaultTemplatesComponent = /** @class */ (function () {
    function IgxFinancialChartDefaultTemplatesComponent(_changeDetectorRef) {
        this._changeDetectorRef = _changeDetectorRef;
        this.onContentReady = new EventEmitter();
    }
    IgxFinancialChartDefaultTemplatesComponent_1 = IgxFinancialChartDefaultTemplatesComponent;
    IgxFinancialChartDefaultTemplatesComponent.prototype.getSelection = function (ele) {
        var ret = [];
    ...
    IgxFinancialChartDefaultTemplatesComponent.register = function () {
        TypeRegistrar.registerCons("IgxFinancialChartDefaultTemplatesComponent", IgxFinancialChartDefaultTemplatesComponent_1);
    };
    IgxFinancialChartDefaultTemplatesComponent.prototype.ngAfterContentInit = function () {
        this.onContentReady.emit({});
    };
    var IgxFinancialChartDefaultTemplatesComponent_1;
    tslib_1.__decorate([
        ViewChild("financialChartRangeSelectorTemplate", { static: true }),
        tslib_1.__metadata("design:type", TemplateRef)
    ], IgxFinancialChartDefaultTemplatesComponent.prototype, "financialChartRangeSelectorTemplate", void 0);
    tslib_1.__decorate([
        ViewChild("financialChartTypePickerTemplate", { static: true }),
        tslib_1.__metadata("design:type", TemplateRef)
    ], IgxFinancialChartDefaultTemplatesComponent.prototype, "financialChartTypePickerTemplate", void 0);
    tslib_1.__decorate([
        ViewChild("financialChartIndicatorMenuTemplate", { static: true }),
        tslib_1.__metadata("design:type", TemplateRef)
    ], IgxFinancialChartDefaultTemplatesComponent.prototype, "financialChartIndicatorMenuTemplate", void 0);
    tslib_1.__decorate([
        ViewChild("financialChartToolbarTemplate", { static: true }),
        tslib_1.__metadata("design:type", TemplateRef)
    ], IgxFinancialChartDefaultTemplatesComponent.prototype, "financialChartToolbarTemplate", void 0);
    tslib_1.__decorate([
        Output(),
        tslib_1.__metadata("design:type", EventEmitter)
    ], IgxFinancialChartDefaultTemplatesComponent.prototype, "onContentReady", void 0);
    IgxFinancialChartDefaultTemplatesComponent = IgxFinancialChartDefaultTemplatesComponent_1 = tslib_1.__decorate([
        Component({
    ...
    return IgxFinancialChartDefaultTemplatesComponent;
}());
export { IgxFinancialChartDefaultTemplatesComponent };
//# sourceMappingURL=igx-financial-chart-default-templates-component.js.map