...
var IgxFullStochasticOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxFullStochasticOscillatorIndicatorDynamicModule() {
    ...
    IgxFullStochasticOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxFullStochasticOscillatorIndicatorDynamicModule;
}());
export { IgxFullStochasticOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-full-stochastic-oscillator-indicator-dynamic-module.js.map