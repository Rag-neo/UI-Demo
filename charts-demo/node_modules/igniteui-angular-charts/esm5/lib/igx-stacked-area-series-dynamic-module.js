...
var IgxStackedAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxStackedAreaSeriesDynamicModule() {
    ...
    IgxStackedAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStackedAreaSeriesDynamicModule;
}());
export { IgxStackedAreaSeriesDynamicModule };
//# sourceMappingURL=igx-stacked-area-series-dynamic-module.js.map