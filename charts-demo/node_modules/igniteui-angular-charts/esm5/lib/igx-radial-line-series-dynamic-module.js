...
var IgxRadialLineSeriesDynamicModule = /** @class */ (function () {
    function IgxRadialLineSeriesDynamicModule() {
    ...
    IgxRadialLineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRadialLineSeriesDynamicModule;
}());
export { IgxRadialLineSeriesDynamicModule };
//# sourceMappingURL=igx-radial-line-series-dynamic-module.js.map