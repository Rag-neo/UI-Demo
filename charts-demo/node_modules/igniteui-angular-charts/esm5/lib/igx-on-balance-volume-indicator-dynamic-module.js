...
var IgxOnBalanceVolumeIndicatorDynamicModule = /** @class */ (function () {
    function IgxOnBalanceVolumeIndicatorDynamicModule() {
    ...
    IgxOnBalanceVolumeIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxOnBalanceVolumeIndicatorDynamicModule;
}());
export { IgxOnBalanceVolumeIndicatorDynamicModule };
//# sourceMappingURL=igx-on-balance-volume-indicator-dynamic-module.js.map