...
var IgxDoughnutChartDynamicModule = /** @class */ (function () {
    function IgxDoughnutChartDynamicModule() {
    }
    IgxDoughnutChartDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxDoughnutChartDynamicModule);
    return IgxDoughnutChartDynamicModule;
}());
export { IgxDoughnutChartDynamicModule };
//# sourceMappingURL=igx-doughnut-chart-dynamic-module.js.map