...
*/
export var IgxValueOverlayComponent_PROVIDERS = [{ provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxValueOverlayComponent; }) }];
var IgxValueOverlayComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxValueOverlayComponent, _super);
    function IgxValueOverlayComponent() {
        return _super.call(this) || this;
    }
    IgxValueOverlayComponent_1 = IgxValueOverlayComponent;
        ...
        */
        get: function () {
            ...
            if (!this.i.l1.externalObject) {
                var e = IgxAxisComponent._createFromInternal(this.i.l1);
                if (e) {
    ...
    */
    ...
    IgxValueOverlayComponent = IgxValueOverlayComponent_1 = tslib_1.__decorate([
        Component({
            ...
            template: "",
            providers: [{ provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxValueOverlayComponent_1; }) }],
