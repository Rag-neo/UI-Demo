...
var IgxCategoryToolTipLayerModule = /** @class */ (function () {
    function IgxCategoryToolTipLayerModule() {
    }
    IgxCategoryToolTipLayerModule = tslib_1.__decorate([
        NgModule({
    ...
    return IgxCategoryToolTipLayerModule;
}());
export { IgxCategoryToolTipLayerModule };
//# sourceMappingURL=igx-category-tool-tip-layer-module.js.map