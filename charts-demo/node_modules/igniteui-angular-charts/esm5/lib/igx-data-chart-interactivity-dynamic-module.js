...
var IgxDataChartInteractivityDynamicModule = /** @class */ (function () {
    function IgxDataChartInteractivityDynamicModule() {
    ...
    IgxDataChartInteractivityDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartInteractivityDynamicModule;
}());
export { IgxDataChartInteractivityDynamicModule };
//# sourceMappingURL=igx-data-chart-interactivity-dynamic-module.js.map