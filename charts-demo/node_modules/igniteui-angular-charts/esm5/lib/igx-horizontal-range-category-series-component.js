...
* ```
*/
export var IgxHorizontalRangeCategorySeriesComponent_PROVIDERS = [{ provide: IgxRangeCategorySeriesComponent, useExisting: forwardRef(function () { return IgxHorizontalRangeCategorySeriesComponent; }) }, { provide: IgxCategorySeriesComponent, useExisting: forwardRef(function () { return IgxHorizontalRangeCategorySeriesComponent; }) }, { provide: IgxMarkerSeriesComponent, useExisting: forwardRef(function () { return IgxHorizontalRangeCategorySeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxHorizontalRangeCategorySeriesComponent; }) }];
var IgxHorizontalRangeCategorySeriesComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxHorizontalRangeCategorySeriesComponent, _super);
