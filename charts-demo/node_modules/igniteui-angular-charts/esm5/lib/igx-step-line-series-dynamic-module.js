...
var IgxStepLineSeriesDynamicModule = /** @class */ (function () {
    function IgxStepLineSeriesDynamicModule() {
    ...
    IgxStepLineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStepLineSeriesDynamicModule;
}());
export { IgxStepLineSeriesDynamicModule };
//# sourceMappingURL=igx-step-line-series-dynamic-module.js.map