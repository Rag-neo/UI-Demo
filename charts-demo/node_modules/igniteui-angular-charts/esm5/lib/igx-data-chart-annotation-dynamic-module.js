...
var IgxDataChartAnnotationDynamicModule = /** @class */ (function () {
    function IgxDataChartAnnotationDynamicModule() {
    ...
    IgxDataChartAnnotationDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartAnnotationDynamicModule;
}());
export { IgxDataChartAnnotationDynamicModule };
//# sourceMappingURL=igx-data-chart-annotation-dynamic-module.js.map