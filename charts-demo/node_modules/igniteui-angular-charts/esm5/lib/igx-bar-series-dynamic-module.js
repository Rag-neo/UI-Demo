...
var IgxBarSeriesDynamicModule = /** @class */ (function () {
    function IgxBarSeriesDynamicModule() {
        TypeRegistrar.registerCons("IgxBarSeriesComponent", IgxBarSeriesComponent);
        TypeRegistrar.register("BarSeries", BarSeries.$type);
    }
    IgxBarSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxBarSeriesDynamicModule;
}());
export { IgxBarSeriesDynamicModule };
//# sourceMappingURL=igx-bar-series-dynamic-module.js.map