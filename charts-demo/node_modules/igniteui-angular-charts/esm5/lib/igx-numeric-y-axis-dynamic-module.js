...
var IgxNumericYAxisDynamicModule = /** @class */ (function () {
    function IgxNumericYAxisDynamicModule() {
    ...
    IgxNumericYAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxNumericYAxisDynamicModule;
}());
export { IgxNumericYAxisDynamicModule };
//# sourceMappingURL=igx-numeric-y-axis-dynamic-module.js.map