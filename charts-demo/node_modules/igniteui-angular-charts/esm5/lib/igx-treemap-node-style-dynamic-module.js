...
var IgxTreemapNodeStyleDynamicModule = /** @class */ (function () {
    function IgxTreemapNodeStyleDynamicModule() {
    ...
    IgxTreemapNodeStyleDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxTreemapNodeStyleDynamicModule;
}());
export { IgxTreemapNodeStyleDynamicModule };
//# sourceMappingURL=igx-treemap-node-style-dynamic-module.js.map