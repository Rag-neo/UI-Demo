...
var IgxBollingerBandWidthIndicatorDynamicModule = /** @class */ (function () {
    function IgxBollingerBandWidthIndicatorDynamicModule() {
    ...
    IgxBollingerBandWidthIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxBollingerBandWidthIndicatorDynamicModule;
}());
export { IgxBollingerBandWidthIndicatorDynamicModule };
//# sourceMappingURL=igx-bollinger-band-width-indicator-dynamic-module.js.map