...
var IgxFastStochasticOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxFastStochasticOscillatorIndicatorDynamicModule() {
    ...
    IgxFastStochasticOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxFastStochasticOscillatorIndicatorDynamicModule;
}());
export { IgxFastStochasticOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-fast-stochastic-oscillator-indicator-dynamic-module.js.map