...
var IgxWeightedCloseIndicatorDynamicModule = /** @class */ (function () {
    function IgxWeightedCloseIndicatorDynamicModule() {
    ...
    IgxWeightedCloseIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxWeightedCloseIndicatorDynamicModule;
}());
export { IgxWeightedCloseIndicatorDynamicModule };
//# sourceMappingURL=igx-weighted-close-indicator-dynamic-module.js.map