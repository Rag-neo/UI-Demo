...
var IgxSplineAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxSplineAreaSeriesDynamicModule() {
    ...
    IgxSplineAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSplineAreaSeriesDynamicModule;
}());
export { IgxSplineAreaSeriesDynamicModule };
//# sourceMappingURL=igx-spline-area-series-dynamic-module.js.map