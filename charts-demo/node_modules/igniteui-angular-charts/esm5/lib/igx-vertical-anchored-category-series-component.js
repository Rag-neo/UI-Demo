...
*/
export var IgxVerticalAnchoredCategorySeriesComponent_PROVIDERS = [{ provide: IgxAnchoredCategorySeriesComponent, useExisting: forwardRef(function () { return IgxVerticalAnchoredCategorySeriesComponent; }) }, { provide: IgxCategorySeriesComponent, useExisting: forwardRef(function () { return IgxVerticalAnchoredCategorySeriesComponent; }) }, { provide: IgxMarkerSeriesComponent, useExisting: forwardRef(function () { return IgxVerticalAnchoredCategorySeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxVerticalAnchoredCategorySeriesComponent; }) }];
var IgxVerticalAnchoredCategorySeriesComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxVerticalAnchoredCategorySeriesComponent, _super);
        ...
        */
        get: function () {
            ...
            if (!this.i.xAxis.externalObject) {
                var e = IgxNumericXAxisComponent._createFromInternal(this.i.xAxis);
                if (e) {
        ...
        */
        get: function () {
            ...
            if (!this.i.yAxis.externalObject) {
                var e = IgxCategoryYAxisComponent._createFromInternal(this.i.yAxis);
                if (e) {
    ...
    */
    ...
    ], IgxVerticalAnchoredCategorySeriesComponent.prototype, "xAxis", null);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", IgxCategoryYAxisComponent),
        tslib_1.__metadata("design:paramtypes", [IgxCategoryYAxisComponent])
    ], IgxVerticalAnchoredCategorySeriesComponent.prototype, "yAxis", null);
...
//# sourceMappingURL=igx-vertical-anchored-category-series-component.js.map