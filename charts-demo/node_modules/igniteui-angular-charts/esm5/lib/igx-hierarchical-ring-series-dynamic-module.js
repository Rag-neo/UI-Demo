...
var IgxHierarchicalRingSeriesDynamicModule = /** @class */ (function () {
    function IgxHierarchicalRingSeriesDynamicModule() {
    ...
    IgxHierarchicalRingSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxHierarchicalRingSeriesDynamicModule);
    return IgxHierarchicalRingSeriesDynamicModule;
}());
export { IgxHierarchicalRingSeriesDynamicModule };
//# sourceMappingURL=igx-hierarchical-ring-series-dynamic-module.js.map