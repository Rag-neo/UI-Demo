...
var IgxHighDensityScatterSeriesDynamicModule = /** @class */ (function () {
    function IgxHighDensityScatterSeriesDynamicModule() {
    ...
    IgxHighDensityScatterSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxHighDensityScatterSeriesDynamicModule;
}());
export { IgxHighDensityScatterSeriesDynamicModule };
//# sourceMappingURL=igx-high-density-scatter-series-dynamic-module.js.map