...
var IgxFinancialPriceSeriesProxyModule = /** @class */ (function () {
    function IgxFinancialPriceSeriesProxyModule() {
    ...
    IgxFinancialPriceSeriesProxyModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
            exports: [],
    ...
    return IgxFinancialPriceSeriesProxyModule;
}());
export { IgxFinancialPriceSeriesProxyModule };
//# sourceMappingURL=igx-financial-price-series-proxy-module.js.map