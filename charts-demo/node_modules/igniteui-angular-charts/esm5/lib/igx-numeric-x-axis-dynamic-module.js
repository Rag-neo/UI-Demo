...
var IgxNumericXAxisDynamicModule = /** @class */ (function () {
    function IgxNumericXAxisDynamicModule() {
    ...
    IgxNumericXAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxNumericXAxisDynamicModule;
}());
export { IgxNumericXAxisDynamicModule };
//# sourceMappingURL=igx-numeric-x-axis-dynamic-module.js.map