...
var IgxDataChartCategoryCoreDynamicModule = /** @class */ (function () {
    function IgxDataChartCategoryCoreDynamicModule() {
    }
    IgxDataChartCategoryCoreDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartCategoryCoreDynamicModule;
}());
export { IgxDataChartCategoryCoreDynamicModule };
//# sourceMappingURL=igx-data-chart-category-core-dynamic-module.js.map