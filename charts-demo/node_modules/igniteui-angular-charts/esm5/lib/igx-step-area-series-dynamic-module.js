...
var IgxStepAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxStepAreaSeriesDynamicModule() {
    ...
    IgxStepAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStepAreaSeriesDynamicModule;
}());
export { IgxStepAreaSeriesDynamicModule };
//# sourceMappingURL=igx-step-area-series-dynamic-module.js.map