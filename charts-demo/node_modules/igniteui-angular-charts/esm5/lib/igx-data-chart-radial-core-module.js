...
var IgxDataChartRadialCoreModule = /** @class */ (function () {
    function IgxDataChartRadialCoreModule() {
    }
    IgxDataChartRadialCoreModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartRadialCoreModule;
}());
export { IgxDataChartRadialCoreModule };
//# sourceMappingURL=igx-data-chart-radial-core-module.js.map