...
var IgxAbsoluteVolumeOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxAbsoluteVolumeOscillatorIndicatorDynamicModule() {
    ...
    IgxAbsoluteVolumeOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAbsoluteVolumeOscillatorIndicatorDynamicModule;
}());
export { IgxAbsoluteVolumeOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-absolute-volume-oscillator-indicator-dynamic-module.js.map