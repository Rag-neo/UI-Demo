...
var IgxRangeAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxRangeAreaSeriesDynamicModule() {
    ...
    IgxRangeAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRangeAreaSeriesDynamicModule;
}());
export { IgxRangeAreaSeriesDynamicModule };
//# sourceMappingURL=igx-range-area-series-dynamic-module.js.map