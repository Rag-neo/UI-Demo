...
*/
export var IgxCustomPaletteBrushScaleComponent_PROVIDERS = [{ provide: IgxBrushScaleComponent, useExisting: forwardRef(function () { return IgxCustomPaletteBrushScaleComponent; }) }];
var IgxCustomPaletteBrushScaleComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxCustomPaletteBrushScaleComponent, _super);
    function IgxCustomPaletteBrushScaleComponent() {
        return _super.call(this) || this;
    }
    IgxCustomPaletteBrushScaleComponent_1 = IgxCustomPaletteBrushScaleComponent;
    ...
    var IgxCustomPaletteBrushScaleComponent_1;
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", Number),
        tslib_1.__metadata("design:paramtypes", [Number])
    ], IgxCustomPaletteBrushScaleComponent.prototype, "brushSelectionMode", null);
    IgxCustomPaletteBrushScaleComponent = IgxCustomPaletteBrushScaleComponent_1 = tslib_1.__decorate([
        Component({
            selector: 'igx-custom-palette-brush-scale',
            template: "",
            providers: [{ provide: IgxBrushScaleComponent, useExisting: forwardRef(function () { return IgxCustomPaletteBrushScaleComponent_1; }) }],
...
//# sourceMappingURL=igx-custom-palette-brush-scale-component.js.map