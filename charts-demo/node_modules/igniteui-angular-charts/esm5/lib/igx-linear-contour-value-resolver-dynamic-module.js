...
var IgxLinearContourValueResolverDynamicModule = /** @class */ (function () {
    function IgxLinearContourValueResolverDynamicModule() {
    ...
    IgxLinearContourValueResolverDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxLinearContourValueResolverDynamicModule);
    return IgxLinearContourValueResolverDynamicModule;
}());
export { IgxLinearContourValueResolverDynamicModule };
//# sourceMappingURL=igx-linear-contour-value-resolver-dynamic-module.js.map