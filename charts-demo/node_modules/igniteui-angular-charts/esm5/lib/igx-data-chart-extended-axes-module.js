...
var IgxDataChartExtendedAxesModule = /** @class */ (function () {
    function IgxDataChartExtendedAxesModule() {
    }
    IgxDataChartExtendedAxesModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
            exports: [IgxCategoryDateTimeXAxisModule,
                IgxTimeAxisBreakModule,
                IgxTimeAxisIntervalModule,
    ...
    return IgxDataChartExtendedAxesModule;
}());
export { IgxDataChartExtendedAxesModule };
//# sourceMappingURL=igx-data-chart-extended-axes-module.js.map