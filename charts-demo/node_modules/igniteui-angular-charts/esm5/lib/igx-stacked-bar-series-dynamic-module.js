...
var IgxStackedBarSeriesDynamicModule = /** @class */ (function () {
    function IgxStackedBarSeriesDynamicModule() {
    ...
    IgxStackedBarSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStackedBarSeriesDynamicModule;
}());
export { IgxStackedBarSeriesDynamicModule };
//# sourceMappingURL=igx-stacked-bar-series-dynamic-module.js.map