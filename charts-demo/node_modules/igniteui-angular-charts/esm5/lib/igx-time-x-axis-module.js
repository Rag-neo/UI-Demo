...
var IgxTimeXAxisModule = /** @class */ (function () {
    function IgxTimeXAxisModule() {
    }
    IgxTimeXAxisModule = tslib_1.__decorate([
        NgModule({
    ...
    return IgxTimeXAxisModule;
}());
export { IgxTimeXAxisModule };
//# sourceMappingURL=igx-time-x-axis-module.js.map