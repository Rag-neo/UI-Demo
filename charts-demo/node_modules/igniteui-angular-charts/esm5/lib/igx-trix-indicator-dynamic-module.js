...
var IgxTRIXIndicatorDynamicModule = /** @class */ (function () {
    function IgxTRIXIndicatorDynamicModule() {
    ...
    IgxTRIXIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxTRIXIndicatorDynamicModule;
}());
export { IgxTRIXIndicatorDynamicModule };
//# sourceMappingURL=igx-trix-indicator-dynamic-module.js.map