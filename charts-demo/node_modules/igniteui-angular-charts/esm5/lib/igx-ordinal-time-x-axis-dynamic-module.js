...
var IgxOrdinalTimeXAxisDynamicModule = /** @class */ (function () {
    function IgxOrdinalTimeXAxisDynamicModule() {
    ...
    IgxOrdinalTimeXAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxOrdinalTimeXAxisDynamicModule;
}());
export { IgxOrdinalTimeXAxisDynamicModule };
//# sourceMappingURL=igx-ordinal-time-x-axis-dynamic-module.js.map