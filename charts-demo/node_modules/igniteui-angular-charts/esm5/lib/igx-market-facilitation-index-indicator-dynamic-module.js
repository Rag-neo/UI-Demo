...
var IgxMarketFacilitationIndexIndicatorDynamicModule = /** @class */ (function () {
    function IgxMarketFacilitationIndexIndicatorDynamicModule() {
    ...
    IgxMarketFacilitationIndexIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxMarketFacilitationIndexIndicatorDynamicModule;
}());
export { IgxMarketFacilitationIndexIndicatorDynamicModule };
//# sourceMappingURL=igx-market-facilitation-index-indicator-dynamic-module.js.map