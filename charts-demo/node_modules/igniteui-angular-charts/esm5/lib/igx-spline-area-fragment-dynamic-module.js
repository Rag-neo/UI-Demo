...
var IgxSplineAreaFragmentDynamicModule = /** @class */ (function () {
    function IgxSplineAreaFragmentDynamicModule() {
    ...
    IgxSplineAreaFragmentDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSplineAreaFragmentDynamicModule;
}());
export { IgxSplineAreaFragmentDynamicModule };
//# sourceMappingURL=igx-spline-area-fragment-dynamic-module.js.map