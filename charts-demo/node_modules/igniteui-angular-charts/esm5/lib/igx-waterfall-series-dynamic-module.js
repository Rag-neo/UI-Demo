...
var IgxWaterfallSeriesDynamicModule = /** @class */ (function () {
    function IgxWaterfallSeriesDynamicModule() {
    ...
    IgxWaterfallSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxWaterfallSeriesDynamicModule;
}());
export { IgxWaterfallSeriesDynamicModule };
//# sourceMappingURL=igx-waterfall-series-dynamic-module.js.map