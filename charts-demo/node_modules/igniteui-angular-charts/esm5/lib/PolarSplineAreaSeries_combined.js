 ...
 * @hidden
 */
var PolarSplineAreaSeries = /** @class */ (function (_super) {
    tslib_1.__extends(PolarSplineAreaSeries, _super);
    function PolarSplineAreaSeries() {
        var _this = _super.call(this) || this;
        _this.ab = PolarSplineAreaSeries.$;
        return _this;
    }
    PolarSplineAreaSeries.prototype.bf = function () {
        return new PolarSplineAreaSeriesView(this);
    };
    PolarSplineAreaSeries.prototype.iv = function (a) {
        _super.prototype.iv.call(this, a);
        this.ph = a;
    };
    PolarSplineAreaSeries.prototype.pf = function (a) {
        var b = a;
        b.c0();
    };
    PolarSplineAreaSeries.prototype.pg = function (a, b) {
        this.pf(b);
        if (a.m.count < 1) {
            return;
        }
    ...
    PolarSplineAreaSeries.prototype.get_pc = function () {
        return true;
    };
    PolarSplineAreaSeries.prototype.i0 = function (a, b, c, d) {
    ...
    PolarSplineAreaSeries.$$p = markDep(DependencyProperty, PropertyMetadata, PolarSplineAreaSeries, 'raisePropertyChanged', ['Stiffness:pi:pk', [1, 0.5]]);
 ...
 * @hidden
 */
var PolarSplineAreaSeriesView = /** @class */ (function (_super) {
    tslib_1.__extends(PolarSplineAreaSeriesView, _super);
    ...
    PolarSplineAreaSeriesView.prototype.ap = function () {
        _super.prototype.ap.call(this);
        if (!this.n) {
            this.e.bj = 1;
        }
    };
    Object.defineProperty(PolarSplineAreaSeriesView.prototype, "c3", {
        get: function () {
            return this.c2;
        },
        enumerable: true,
    ...
    PolarSplineAreaSeriesView.prototype.c0 = function () {
        Extensions.e(this.c2.ak);
        Extensions.e(this.c4.ak);
        this.an();
    };
    PolarSplineAreaSeriesView.prototype.c1 = function (a, b) {
        this.c4.ak.c = Numeric.h(a.count + 1, function (c) { return c < a.count ? a._inner[c].x : a._inner[c - a.count].x; }, function (c) { return c < a.count ? a._inner[c].y : a._inner[c - a.count].y; }, b);
        this.c2.ak.c = Numeric.h(a.count + 1, function (c) { return c < a.count ? a._inner[c].x : a._inner[c - a.count].x; }, function (c) { return c < a.count ? a._inner[c].y : a._inner[c - a.count].y; }, b);
        this.an();
    };
    PolarSplineAreaSeriesView.prototype.a8 = function () {
    ...
    PolarSplineAreaSeriesView.prototype.a9 = function () {
    ...
    PolarSplineAreaSeriesView.prototype.a3 = function (a, b) {
    ...
    PolarSplineAreaSeriesView.prototype.ai = function (a) {
    ...
    PolarSplineAreaSeriesView.prototype.ac = function () {
        var a = new Color();
