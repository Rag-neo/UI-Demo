...
var IgxItemToolTipLayerModule = /** @class */ (function () {
    function IgxItemToolTipLayerModule() {
    }
    IgxItemToolTipLayerModule = tslib_1.__decorate([
        NgModule({
    ...
    return IgxItemToolTipLayerModule;
}());
export { IgxItemToolTipLayerModule };
//# sourceMappingURL=igx-item-tool-tip-layer-module.js.map