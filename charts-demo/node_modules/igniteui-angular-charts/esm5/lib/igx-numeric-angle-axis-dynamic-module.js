...
var IgxNumericAngleAxisDynamicModule = /** @class */ (function () {
    function IgxNumericAngleAxisDynamicModule() {
    ...
    IgxNumericAngleAxisDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxNumericAngleAxisDynamicModule;
}());
export { IgxNumericAngleAxisDynamicModule };
//# sourceMappingURL=igx-numeric-angle-axis-dynamic-module.js.map