...
var IgxPieChartModule = /** @class */ (function () {
    function IgxPieChartModule() {
    }
    IgxPieChartModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPieChartModule;
}());
export { IgxPieChartModule };
//# sourceMappingURL=igx-pie-chart-module.js.map