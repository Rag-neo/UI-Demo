...
var IgxStackedFragmentSeriesDynamicModule = /** @class */ (function () {
    function IgxStackedFragmentSeriesDynamicModule() {
    ...
    IgxStackedFragmentSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxStackedFragmentSeriesDynamicModule;
}());
export { IgxStackedFragmentSeriesDynamicModule };
//# sourceMappingURL=igx-stacked-fragment-series-dynamic-module.js.map