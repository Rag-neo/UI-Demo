...
var IgxBarFragmentDynamicModule = /** @class */ (function () {
    function IgxBarFragmentDynamicModule() {
    ...
    IgxBarFragmentDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxBarFragmentDynamicModule;
}());
export { IgxBarFragmentDynamicModule };
//# sourceMappingURL=igx-bar-fragment-dynamic-module.js.map