...
var IgxPieChartDynamicModule = /** @class */ (function () {
    function IgxPieChartDynamicModule() {
    }
    IgxPieChartDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxPieChartDynamicModule);
    return IgxPieChartDynamicModule;
}());
export { IgxPieChartDynamicModule };
//# sourceMappingURL=igx-pie-chart-dynamic-module.js.map