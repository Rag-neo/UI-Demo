...
export var IgxFinancialLegendComponent_PROVIDERS = [{ provide: IgxLegendBaseComponent, useExisting: forwardRef(function () { return IgxFinancialLegendComponent; }) }];
/**
 * Represents a legend that displays information about each series, most often used in financial charting.
*/
var IgxFinancialLegendComponent = /** @class */ (function (_super) {
    tslib_1.__extends(IgxFinancialLegendComponent, _super);
    ...
    IgxFinancialLegendComponent_1 = IgxFinancialLegendComponent;
    ...
    */
    ...
    var IgxFinancialLegendComponent_1;
    IgxFinancialLegendComponent = IgxFinancialLegendComponent_1 = tslib_1.__decorate([
        Component({
            selector: 'igx-financial-legend',
            template: "",
            providers: [{ provide: IgxLegendBaseComponent, useExisting: forwardRef(function () { return IgxFinancialLegendComponent_1; }) }],
...
//# sourceMappingURL=igx-financial-legend-component.js.map