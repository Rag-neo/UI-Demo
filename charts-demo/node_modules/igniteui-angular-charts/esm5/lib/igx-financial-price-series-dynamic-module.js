...
var IgxFinancialPriceSeriesDynamicModule = /** @class */ (function () {
    function IgxFinancialPriceSeriesDynamicModule() {
    ...
    IgxFinancialPriceSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxFinancialPriceSeriesDynamicModule;
}());
export { IgxFinancialPriceSeriesDynamicModule };
//# sourceMappingURL=igx-financial-price-series-dynamic-module.js.map