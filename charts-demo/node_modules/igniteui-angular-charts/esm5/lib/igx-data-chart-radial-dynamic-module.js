...
var IgxDataChartRadialDynamicModule = /** @class */ (function () {
    function IgxDataChartRadialDynamicModule() {
    }
    IgxDataChartRadialDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxDataChartRadialDynamicModule);
    return IgxDataChartRadialDynamicModule;
}());
export { IgxDataChartRadialDynamicModule };
//# sourceMappingURL=igx-data-chart-radial-dynamic-module.js.map