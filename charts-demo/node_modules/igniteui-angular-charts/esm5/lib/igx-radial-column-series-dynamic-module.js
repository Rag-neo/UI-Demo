...
var IgxRadialColumnSeriesDynamicModule = /** @class */ (function () {
    function IgxRadialColumnSeriesDynamicModule() {
    ...
    IgxRadialColumnSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRadialColumnSeriesDynamicModule;
}());
export { IgxRadialColumnSeriesDynamicModule };
//# sourceMappingURL=igx-radial-column-series-dynamic-module.js.map