...
var IgxRateOfChangeAndMomentumIndicatorDynamicModule = /** @class */ (function () {
    function IgxRateOfChangeAndMomentumIndicatorDynamicModule() {
    ...
    IgxRateOfChangeAndMomentumIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRateOfChangeAndMomentumIndicatorDynamicModule;
}());
export { IgxRateOfChangeAndMomentumIndicatorDynamicModule };
//# sourceMappingURL=igx-rate-of-change-and-momentum-indicator-dynamic-module.js.map