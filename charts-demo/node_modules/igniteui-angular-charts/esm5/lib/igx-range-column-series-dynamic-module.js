...
var IgxRangeColumnSeriesDynamicModule = /** @class */ (function () {
    function IgxRangeColumnSeriesDynamicModule() {
    ...
    IgxRangeColumnSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxRangeColumnSeriesDynamicModule;
}());
export { IgxRangeColumnSeriesDynamicModule };
//# sourceMappingURL=igx-range-column-series-dynamic-module.js.map