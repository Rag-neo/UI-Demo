...
var IgxAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxAreaSeriesDynamicModule() {
    ...
    IgxAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxAreaSeriesDynamicModule;
}());
export { IgxAreaSeriesDynamicModule };
//# sourceMappingURL=igx-area-series-dynamic-module.js.map