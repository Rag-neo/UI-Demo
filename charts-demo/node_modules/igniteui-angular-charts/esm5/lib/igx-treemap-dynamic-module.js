...
var IgxTreemapDynamicModule = /** @class */ (function () {
    function IgxTreemapDynamicModule() {
    ...
    IgxTreemapDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxTreemapDynamicModule);
    return IgxTreemapDynamicModule;
}());
export { IgxTreemapDynamicModule };
//# sourceMappingURL=igx-treemap-dynamic-module.js.map