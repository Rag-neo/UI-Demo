...
var IgxCrosshairLayerDynamicModule = /** @class */ (function () {
    function IgxCrosshairLayerDynamicModule() {
    ...
    IgxCrosshairLayerDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCrosshairLayerDynamicModule;
}());
export { IgxCrosshairLayerDynamicModule };
//# sourceMappingURL=igx-crosshair-layer-dynamic-module.js.map