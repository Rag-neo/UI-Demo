...
var IgxFinancialPriceSeriesProxyDynamicModule = /** @class */ (function () {
    function IgxFinancialPriceSeriesProxyDynamicModule() {
    ...
    IgxFinancialPriceSeriesProxyDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
            exports: [],
    ...
    ], IgxFinancialPriceSeriesProxyDynamicModule);
    return IgxFinancialPriceSeriesProxyDynamicModule;
}());
export { IgxFinancialPriceSeriesProxyDynamicModule };
//# sourceMappingURL=igx-financial-price-series-proxy-dynamic-module.js.map