...
var IgxEaseOfMovementIndicatorDynamicModule = /** @class */ (function () {
    function IgxEaseOfMovementIndicatorDynamicModule() {
    ...
    IgxEaseOfMovementIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxEaseOfMovementIndicatorDynamicModule;
}());
export { IgxEaseOfMovementIndicatorDynamicModule };
//# sourceMappingURL=igx-ease-of-movement-indicator-dynamic-module.js.map