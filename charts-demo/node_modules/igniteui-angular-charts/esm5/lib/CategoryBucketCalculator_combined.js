...
import { Base, typeCast, markType, Array_$type, Number_$type, Point_$type, enumGetBox, runOn, fromEnum, markDep } from "igniteui-angular-core";
 ...
 * @hidden
 */
var CategoryBucketCalculator = /** @class */ (function (_super) {
    tslib_1.__extends(CategoryBucketCalculator, _super);
    ...
    CategoryBucketCalculator.prototype.g = function (a) {
        ...
        if (i == null || i.i$b == null) {
            var j = new ScalerParams(0, b, c, e.ca, g);
            var k = Math.floor(e.d2(h.left, j, 0));
            var l = Math.ceil(e.d2(h.right, j, 0));
            if (e.ca) {
                l = Math.ceil(e.d2(h.left, j, 0));
                k = Math.floor(e.d2(h.right, j, 0));
            }
 ...
 * @hidden
 */
var CategoryFramePreparerBase = /** @class */ (function (_super) {
    tslib_1.__extends(CategoryFramePreparerBase, _super);
    ...
    CategoryFramePreparerBase.prototype.t = function (a, b, c, d, e) {
        ...
        var k = a.m;
        var l = a.l;
        var m = typeCast(NumericAxisBase.$, a.c) !== null && a.c.j1;
        var n = a.f;
        ...
        var x = ((function () {
            ...
            $ret.b = typeCast(Series.$, _this.h) !== null ? _this.h.eh() : NaN;
            return $ret;
        })());
        if (j) {
 ...
 * @hidden
 */
var CategoryFramePreparer = /** @class */ (function (_super) {
    tslib_1.__extends(CategoryFramePreparer, _super);
 ...
 * @hidden
 */
var CategorySeries = /** @class */ (function (_super) {
    ...
    function CategorySeries() {
        ...
        _this.nq = null;
        _this.nr = null;
        _this.nc = new CategoryFrame(3);
        _this.ne = new CategoryFrame(3);
        _this.nb = new CategoryFrame(3);
        _this.nd = new CategoryFrame(3);
        _this.ni = null;
        _this.nm = null;
        _this.ni = new CategorySeriesRenderManager();
        _this.nm = new CategoryTransitionSourceFramePreparer();
        _this.nw = false;
        _this.nv = false;
        _this.ab = CategorySeries.$;
        return _this;
    }
    CategorySeries.prototype.bf = function () {
        var a = new CategorySeriesView(this);
        return a;
    };
    Object.defineProperty(CategorySeries.prototype, "nt", {
        get: function () {
            var _this = this;
            if (this.ns == null) {
                this.ns = DVContainer.instance.createInstance(ICategorySeriesInteractionManager_$type, function () { return _this.b2.n; });
            }
            return this.ns;
        },
        enumerable: true,
    ...
    CategorySeries.prototype.ch = function (a, b, c) {
        var _this = this;
        if (!this.hasMarkers) {
            return false;
        }
        ...
        var f = new ScalerParams(1, this.bs.mr, this.lz, e.ca);
        f.c = d;
        var g = this.fetchYAxis();
        var h = new ScalerParams(1, this.bs.mr, this.lz, g.ca);
        h.c = d;
        var i = this.bs.mr;
        var j = this.lz;
        var k = this.currentMode2Index;
        var l = 0;
        if (e.b7 && e.b5) {
            l = e.getSeriesOffset(i, j, d, k, e.categoryMode);
        }
        a.clear();
        this.l1.cc(function (m) {
            if (m._visibility == 0) {
                var n = new SeriesPointOfInterest();
                var o = m.n;
                var p = m.o;
                if (o < _this.lz.left || o > _this.lz.right || p < _this.lz.top || p > _this.lz.bottom) {
                    return;
                }
                if (e.b4 && !e.b7 && e.categoryMode != 0) {
                    n.b = m.ak;
                }
                else {
                    n.b = e.d1(o, f);
    ...
    CategorySeries.prototype.oe = function (a, b) {
        if (b >= 0) {
    ...
    CategorySeries.prototype.iv = function (a) {
    ...
    CategorySeries.prototype.na = function () {
        return this.fetchXAxis();
    };
    CategorySeries.prototype.nu = function () {
        return this.fetchYAxis();
    };
    CategorySeries.prototype.get_cl = function () {
        return true;
    };
    ...
    CategorySeries.prototype.n3 = function () {
        return (this.assigningCategoryStyle != null && this.nw) || this.cu;
    };
    CategorySeries.prototype.n4 = function () {
        return (this.assigningCategoryMarkerStyle != null && this.nv) || this.cu;
    };
    CategorySeries.prototype.or = function (a) {
        if (this.assigningCategoryStyle != null && this.nw) {
            this.assigningCategoryStyle(this, a);
        }
    };
    CategorySeries.prototype.oq = function (a) {
        if (this.assigningCategoryMarkerStyle != null && this.nv) {
    ...
    CategorySeries.prototype.hw = function (a, b) {
        _super.prototype.hw.call(this, a, b);
        if (a) {
            this.ol(b);
        }
    };
    CategorySeries.prototype.a8 = function () {
        var a = _super.prototype.a8.call(this);
        return a;
    };
    CategorySeries.prototype.ic = function () {
    ...
    CategorySeries.prototype.ju = function (a, b) {
        _super.prototype.ju.call(this, a, b);
        this.nj.cn.g(this.eu);
        this.je(false);
    };
    CategorySeries.prototype.jt = function (a, b) {
    ...
    CategorySeries.prototype.i0 = function (a, b, c, d) {
        ...
        switch (b) {
            ...
            case "TransitionProgress":
                this.ne.c(this.ez, this.nc, this.nb);
                if (this.cc(this.bi)) {
                    return;
                }
                if (this.ez == 1) {
                    this.nb.v();
                    this.os(this.nb, this.nj);
                    if (this.dm) {
                        this.dm = false;
                        this.hx();
    ...
    CategorySeries.prototype.ny = function () {
        return this.n1;
    };
    CategorySeries.prototype.nx = function () {
        return this.n0;
    };
    CategorySeries.prototype.n9 = function (a) {
        return this.ed(a, this.fetchXAxis());
    };
    CategorySeries.prototype.get_c1 = function () {
        return typeCast(ISortingAxis_$type, this.na()) !== null;
    };
    CategorySeries.prototype.ap = function () {
        return this.na();
    };
    CategorySeries.prototype.fa = function (a) {
        return this.nt.b$d(this, a);
    };
    CategorySeries.prototype.fp = function (a) {
        return this.nt.b$f(this, a);
    };
    CategorySeries.prototype.e8 = function (a) {
        var b = truncate(Math.round(this.eb(a)));
        return b;
    };
    CategorySeries.prototype.eb = function (a) {
        return this.nt.b$c(this, a);
    };
    CategorySeries.prototype.get_nz = function () {
        return false;
    };
    Object.defineProperty(CategorySeries.prototype, "nz", {
        get: function () {
            return this.get_nz();
        },
        enumerable: true,
    ...
    CategorySeries.prototype.au = function (a, b) {
        var c = this.np(a, b, this.nr);
        this.nr = c;
        return c;
    };
    CategorySeries.prototype.get_cv = function () {
        return true;
    };
    CategorySeries.prototype.at = function (a, b) {
        if (this.nz) {
            var c = this.no(a, b, this.nq);
            this.nq = c;
            return c;
        }
        else {
            var d = this.nn(a, b, this.nq);
            this.nq = d;
            return d;
        }
    };
    ...
    CategorySeries.prototype.np = function (a, b, c) {
        if (!this.l4()) {
            return null;
        }
        var d = this.nb;
        ...
        var e = this.n8();
        return this.nt.b$b(this, e, d.f, a, b, c);
    };
    CategorySeries.prototype.no = function (a, b, c) {
        var d = this.nj.cn.e;
        var e = this.nj.cn.f;
        var f = this.nj.cn.d;
        var g = this.nb;
        ...
        return this.nt.b$a(this, g.f, d, e, f, a, b, c);
    };
    CategorySeries.prototype.nn = function (a, b, c) {
    ...
    CategorySeries.prototype.on = function (a, b, c, d, e, f) {
        var g = this.b9;
        this.ni.ab(a, b, c, d, e, f, g);
        var h = this.ni.b;
        var i = null;
        var j = this.bz;
        if (g && this.bs != null) {
    ...
    CategorySeries.prototype.oo = function (a, b, c, d, e, f) {
        var g = this.b9;
        this.ni.ac(a, b, c, d, e, f, g);
        var h = this.ni.c;
        var i = null;
        var j = this.bz;
        if (g && this.bs != null) {
    ...
    CategorySeries.prototype.dw = function (a, b, c) {
        var d = _super.prototype.dw.call(this, a, b, c);
        d = d && this.n7(this.fetchXAxis());
        d = d && this.n7(this.fetchYAxis());
        var e = c;
    ...
    CategorySeries.prototype.n7 = function (a) {
        if (a == null || a.bh == null) {
            return false;
        }
    ...
    CategorySeries.prototype.dc = function () {
        return this.n2;
    };
    CategorySeries.prototype.nk = function () {
        return 12;
    };
    CategorySeries.prototype.hx = function () {
        _super.prototype.hx.call(this);
        this.nc.v();
        this.nb.v();
        this.ne.v();
    };
    CategorySeries.prototype.jf = function (a) {
        ...
        if (this.da(a)) {
            ...
            this.op(this.nb, this.nj);
            if (this.dp) {
                this.bt.w();
                this.bt.r = truncate(this.er());
                this.bt.b = this.bv != null ? this.bv : this.bu;
                this.nm.p(this.nc, this.nb, this.isVertical, this.fetchXAxis(), this.fetchYAxis(), this.nl, this.nk(), this.bp, this.bo(), runOn(this, this.oa), this.nj.br);
            }
            this.ht();
            this.jm();
            if (this.dp) {
    ...
    CategorySeries.prototype.bo = function () {
        return 3;
    };
    CategorySeries.prototype.oa = function () {
        if (this.isVertical) {
            return this.lz.left;
        }
        return this.lz.bottom;
    };
    CategorySeries.prototype.od = function () {
        var e_1, _a;
        var a = 0;
    ...
    CategorySeries.prototype.om = function (a, b) {
        this.ni.w(this, this.n4(), runOn(this, this.m4), this.ob(a), this.oc(a));
        var c = this.ni.b;
        var d = c != null;
        var e = this.na();
        if (e == null) {
        ...
        var g = new ScalerParams(0, a.bs, a.br, e.ca, f);
        var h = this.bz == null ? 0 : this.bz.count;
        var i = a;
        var j = b.f;
        var k = i.cn.e;
        var l = i.cn.f;
        var m = i.cn.d;
        var n = k * m;
        for (var o = 0; o < a.cq.count; o++) {
            var p = a.cq.item(o);
            var q = p.content;
            if (d) {
                var r = p.al;
                this.on(j, r, h, e, g, a.n);
            }
            this.ni.ad(p, q);
        }
    };
    CategorySeries.prototype.os = function (a, b) {
        this.lq = a.aa;
        b.ar();
    };
    CategorySeries.prototype.op = function (a, b) {
        a.u();
    };
    CategorySeries.prototype.ob = function (a) {
        return a.cn.d;
    };
    CategorySeries.prototype.oc = function (a) {
        return a.cn.e;
    };
    CategorySeries.prototype.ol = function (a) {
        var b = a;
        b.cq.count = 0;
    };
    CategorySeries.prototype.jg = function (a, b) {
        _super.prototype.jg.call(this, a, b);
        if (!this.dl) {
            this.bi.az(b);
            return;
        }
        var c = typeCast(CategorySeriesView.$, this.bh);
        c.cn.g(this.eu);
        this.bi.az(b);
        if (this.cc(this.bh)) {
            return;
    ...
    CategorySeries.prototype.ot = function () {
        var a = typeCast(CategorySeriesView.$, this.bh);
        if (!this.df) {
            this.op(this.nd, a);
        }
        this.df = false;
    ...
    CategorySeries.prototype.ng = function (a) {
    ...
    CategorySeries.prototype.am = function (a) {
    ...
    CategorySeries.m5 = function (a, b, c, d, e) {
        var f = null;
    ...
    CategorySeries.$$p = markDep(DependencyProperty, PropertyMetadata, CategorySeries, 'raisePropertyChanged', ['IsCustomCategoryMarkerStyleAllowed:n0:ou', [0, false], 'IsCustomCategoryStyleAllowed:n1:ov', [0, false], 'IsTransitionInEnabled:n2:ow', [0, false], 'TransitionInMode:nl:ox', [CategoryTransitionInMode_$type, enumGetBox(CategoryTransitionInMode_$type, 0)], 'UseHighMarkerFidelity:n6:oy', [0, false]]);
 ...
 * @hidden
 */
var CategorySeriesView = /** @class */ (function (_super) {
    tslib_1.__extends(CategorySeriesView, _super);
    function CategorySeriesView(a) {
        ...
        _this.cq = ((function () {
            ...
            $ret.create = runOn(_this, _this.bx);
            $ret.activate = runOn(_this, _this.cg);
            $ret.disactivate = runOn(_this, _this.ci);
            $ret.destroy = runOn(_this, _this.ch);
            return $ret;
        })());
        return _this;
    }
    CategorySeriesView.prototype.cr = function (a) {
        if (this.cs != a.t) {
            return true;
        }
        return false;
    };
    CategorySeriesView.prototype.cu = function (a) {
        this.cs = a.t;
    };
    CategorySeriesView.prototype.updateMarkerTemplate = function (a, b, c) {
        if (!this.by.l6) {
            var d = this.cq.item(a);
            var e = d.content;
    ...
    CategorySeriesView.prototype.co = function () {
    ...
    CategorySeriesView.prototype.cc = function (a) {
        this.cq.c(a);
    };
    CategorySeriesView.prototype.ct = function () {
    };
...
//# sourceMappingURL=CategoryBucketCalculator_combined.js.map