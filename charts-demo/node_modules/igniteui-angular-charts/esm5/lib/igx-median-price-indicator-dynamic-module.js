...
var IgxMedianPriceIndicatorDynamicModule = /** @class */ (function () {
    function IgxMedianPriceIndicatorDynamicModule() {
    ...
    IgxMedianPriceIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxMedianPriceIndicatorDynamicModule;
}());
export { IgxMedianPriceIndicatorDynamicModule };
//# sourceMappingURL=igx-median-price-indicator-dynamic-module.js.map