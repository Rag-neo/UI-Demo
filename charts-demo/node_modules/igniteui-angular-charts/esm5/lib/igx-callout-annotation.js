...
*/
var IgxCalloutAnnotation = /** @class */ (function () {
    function IgxCalloutAnnotation() {
        this._zoneRunner = null;
        this._implementation = this.createImplementation();
        this._implementation.externalObject = this;
        this.onImplementationCreated();
    }
    IgxCalloutAnnotation.prototype.createImplementation = function () {
        return new CalloutAnnotation_internal();
    };
    Object.defineProperty(IgxCalloutAnnotation.prototype, "i", {
        /**
         * @hidden
         */
        get: function () {
    ...
    IgxCalloutAnnotation.prototype.onImplementationCreated = function () {
    };
    IgxCalloutAnnotation.prototype._provideImplementation = function (i) {
        this._implementation = i;
        this._implementation.externalObject = this;
        this.onImplementationCreated();
    };
    Object.defineProperty(IgxCalloutAnnotation.prototype, "xValue", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "yValue", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "text", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "key", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "content", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "series", {
        /**
        ...
        */
        get: function () {
            ...
            if (!this.i.series.externalObject) {
                var e = IgxSeriesComponent._createFromInternal(this.i.series);
                if (e) {
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "formatLabel", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "textColor", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "background", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "outline", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "leaderBrush", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "strokeThickness", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "backgroundPaddingLeft", {
        /**
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "backgroundPaddingTop", {
        /**
         * Gets or sets the padding to use withing the axis annotation callout. Leaving this NaN will use an automatic value related to the axis label margins.
        */
        get: function () {
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "backgroundPaddingRight", {
        /**
         * Gets or sets the padding to use withing the axis annotation callout. Leaving this NaN will use an automatic value related to the axis label margins.
        */
        get: function () {
    ...
    Object.defineProperty(IgxCalloutAnnotation.prototype, "backgroundPaddingBottom", {
        /**
         * Gets or sets the padding to use withing the axis annotation callout. Leaving this NaN will use an automatic value related to the axis label margins.
        */
        get: function () {
    ...
    IgxCalloutAnnotation.prototype.findByName = function (name) {
        if (this.series && this.series.name && this.series.name == name) {
            return this.series;
        }
        return null;
    };
    IgxCalloutAnnotation.prototype._runInZone = function (act) {
    ...
    return IgxCalloutAnnotation;
}());
export { IgxCalloutAnnotation };
//# sourceMappingURL=igx-callout-annotation.js.map