...
var IgxPolarSplineSeriesDynamicModule = /** @class */ (function () {
    function IgxPolarSplineSeriesDynamicModule() {
    ...
    IgxPolarSplineSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPolarSplineSeriesDynamicModule;
}());
export { IgxPolarSplineSeriesDynamicModule };
//# sourceMappingURL=igx-polar-spline-series-dynamic-module.js.map