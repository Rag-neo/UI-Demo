...
var IgxCategoryHighlightLayerDynamicModule = /** @class */ (function () {
    function IgxCategoryHighlightLayerDynamicModule() {
    ...
    IgxCategoryHighlightLayerDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxCategoryHighlightLayerDynamicModule;
}());
export { IgxCategoryHighlightLayerDynamicModule };
//# sourceMappingURL=igx-category-highlight-layer-dynamic-module.js.map