...
var IgxPercentageVolumeOscillatorIndicatorDynamicModule = /** @class */ (function () {
    function IgxPercentageVolumeOscillatorIndicatorDynamicModule() {
    ...
    IgxPercentageVolumeOscillatorIndicatorDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxPercentageVolumeOscillatorIndicatorDynamicModule;
}());
export { IgxPercentageVolumeOscillatorIndicatorDynamicModule };
//# sourceMappingURL=igx-percentage-volume-oscillator-indicator-dynamic-module.js.map