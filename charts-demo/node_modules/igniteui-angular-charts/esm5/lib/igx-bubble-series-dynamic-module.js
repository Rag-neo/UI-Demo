...
var IgxBubbleSeriesDynamicModule = /** @class */ (function () {
    function IgxBubbleSeriesDynamicModule() {
    ...
    IgxBubbleSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxBubbleSeriesDynamicModule;
}());
export { IgxBubbleSeriesDynamicModule };
//# sourceMappingURL=igx-bubble-series-dynamic-module.js.map