...
var IgxDataChartRadialCoreDynamicModule = /** @class */ (function () {
    function IgxDataChartRadialCoreDynamicModule() {
    }
    IgxDataChartRadialCoreDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxDataChartRadialCoreDynamicModule;
}());
export { IgxDataChartRadialCoreDynamicModule };
//# sourceMappingURL=igx-data-chart-radial-core-dynamic-module.js.map