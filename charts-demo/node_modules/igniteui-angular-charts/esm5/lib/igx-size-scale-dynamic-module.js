...
var IgxSizeScaleDynamicModule = /** @class */ (function () {
    function IgxSizeScaleDynamicModule() {
        TypeRegistrar.registerCons("IgxSizeScaleComponent", IgxSizeScaleComponent);
        TypeRegistrar.register("SizeScale", SizeScale.$type);
    }
    IgxSizeScaleDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxSizeScaleDynamicModule;
}());
export { IgxSizeScaleDynamicModule };
//# sourceMappingURL=igx-size-scale-dynamic-module.js.map