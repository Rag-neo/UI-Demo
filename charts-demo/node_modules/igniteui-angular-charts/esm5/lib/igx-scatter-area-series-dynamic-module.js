...
var IgxScatterAreaSeriesDynamicModule = /** @class */ (function () {
    function IgxScatterAreaSeriesDynamicModule() {
    ...
    IgxScatterAreaSeriesDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxScatterAreaSeriesDynamicModule;
}());
export { IgxScatterAreaSeriesDynamicModule };
//# sourceMappingURL=igx-scatter-area-series-dynamic-module.js.map