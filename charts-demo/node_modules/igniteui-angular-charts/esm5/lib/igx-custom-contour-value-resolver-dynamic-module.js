...
var IgxCustomContourValueResolverDynamicModule = /** @class */ (function () {
    function IgxCustomContourValueResolverDynamicModule() {
    ...
    IgxCustomContourValueResolverDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    ], IgxCustomContourValueResolverDynamicModule);
    return IgxCustomContourValueResolverDynamicModule;
}());
export { IgxCustomContourValueResolverDynamicModule };
//# sourceMappingURL=igx-custom-contour-value-resolver-dynamic-module.js.map