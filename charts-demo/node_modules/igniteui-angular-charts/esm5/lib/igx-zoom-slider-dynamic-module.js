...
var IgxZoomSliderDynamicModule = /** @class */ (function () {
    function IgxZoomSliderDynamicModule() {
    ...
    IgxZoomSliderDynamicModule = tslib_1.__decorate([
        NgModule({
            declarations: [],
    ...
    return IgxZoomSliderDynamicModule;
}());
export { IgxZoomSliderDynamicModule };
//# sourceMappingURL=igx-zoom-slider-dynamic-module.js.map