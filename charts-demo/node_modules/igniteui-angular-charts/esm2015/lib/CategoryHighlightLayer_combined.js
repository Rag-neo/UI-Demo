...
export class CategoryHighlightLayer extends AnnotationLayer {
    ...
    ne(a, b, c) {
        ...
        let f = a.k1({ $type: Point_$type, x: d, y: e }, c, this.m9);
        this.nd(f, b, a);
    }
    nd(a, b, c) {
...
CategoryHighlightLayer.ng = DependencyProperty.i("BAndHighlightWidth", Number_$type, CategoryHighlightLayer.$, new PropertyMetadata(2, 10, (a, b) => a.raisePropertyChanged("BAndHighlightWidth", b.oldValue, b.newValue)));
