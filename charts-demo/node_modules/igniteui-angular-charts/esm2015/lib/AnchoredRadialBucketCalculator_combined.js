...
import { markType, Point_$type, enumGetBox, typeCast, markDep } from "igniteui-angular-core";
...
export class AnchoredRadialSeries extends RadialBase {
    constructor() {
        ...
        this.nv = null;
        this.nz = null;
        this.ot = { $type: Point_$type, x: 0, y: 0 };
        this.nx = null;
        this.nw = null;
        this.nx = new RadialFrame(3);
        this.nv = new CategoryLineRasterizer();
    }
    bf() {
    ...
    en(a, b, c) {
        ...
        let e = this.n5(this.m4, this.bi.bs, this.bi.br, d);
    ...
    lm(a, b, c) {
        ...
        if (!b && this.m4 != null) {
            let h = this.fe(a, c);
            let i = this.fc(a, c);
            let j = this.n5(this.m4, this.bi.bs, this.bi.br, d);
    ...
    no(a, b) {
        ...
        l.ct.q = this.m6.lq;
        l.ct.p = this.m6.lp;
        l.ct.r = (p, q) => this.n6(p, q, c, d);
        l.ct.s = (p, q) => this.n7(p, q, c, d);
        let p = ((() => {
        ...
        l.ct.t(a.p, this.ny, this.n0, this.n9, (r) => this.m4.getScaledAngle(r), (r) => this.m6.lw(r), q, p);
        let r = true;
        if (this.n4(b)) {
            o--;
        }
    ...
    c9(a) {
        ...
        let f = this.m6.lw(this.n0.item(d));
        if (isNaN_(f)) {
...
AnchoredRadialSeries.og = DependencyProperty.i("ActualTrendLineBrush", Brush.$, AnchoredRadialSeries.$, new PropertyMetadata(2, null, (a, b) => a.raisePropertyChanged("ActualTrendLineBrush", b.oldValue, b.newValue)));
