...
export class IgxTreemapNodeStyleMappingCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgxTreemapNodeStyleMappingComponent.$type, TreemapNodeStyleMapping_internal.$type, 0);
