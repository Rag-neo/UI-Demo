...
let IgxRateOfChangeAndMomentumIndicatorComponent = IgxRateOfChangeAndMomentumIndicatorComponent_1 = class IgxRateOfChangeAndMomentumIndicatorComponent extends IgxStrategyBasedIndicatorComponent {
    constructor() {
        super();
    }
...
IgxRateOfChangeAndMomentumIndicatorComponent = IgxRateOfChangeAndMomentumIndicatorComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxStrategyBasedIndicatorComponent, useExisting: forwardRef(() => IgxRateOfChangeAndMomentumIndicatorComponent_1) }, { provide: IgxFinancialIndicatorComponent, useExisting: forwardRef(() => IgxRateOfChangeAndMomentumIndicatorComponent_1) }, { provide: IgxFinancialSeriesComponent, useExisting: forwardRef(() => IgxRateOfChangeAndMomentumIndicatorComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxRateOfChangeAndMomentumIndicatorComponent_1) }],
