...
let IgxCalloutLayerComponent = IgxCalloutLayerComponent_1 = class IgxCalloutLayerComponent extends IgxAnnotationLayerComponent {
    constructor() {
        super();
    ...
    */
    get targetSeries() {
        ...
        if (!this.i.nb.externalObject) {
            let e = IgxSeriesComponent._createFromInternal(this.i.nb);
            if (e) {
...
IgxCalloutLayerComponent = IgxCalloutLayerComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxAnnotationLayerComponent, useExisting: forwardRef(() => IgxCalloutLayerComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxCalloutLayerComponent_1) }],
