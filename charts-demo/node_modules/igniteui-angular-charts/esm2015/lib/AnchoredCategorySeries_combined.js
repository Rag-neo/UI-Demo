...
import { enumGetBox, typeCast, Point_$type, markType, markDep } from "igniteui-angular-core";
...
AnchoredCategorySeries.po = DependencyProperty.i("ActualTrendLineBrush", Brush.$, AnchoredCategorySeries.$, new PropertyMetadata(2, null, (a, b) => a.raisePropertyChanged("ActualTrendLineBrush", b.oldValue, b.newValue)));
