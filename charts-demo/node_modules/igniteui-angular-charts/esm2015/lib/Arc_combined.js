...
export class Arc extends PieChartBase {
    ...
    h7(a) {
        for (let b of fromEnum(this.h3.g)) {
            if (b.b == a) {
                return b;
            }
        }
    ...
    f0() {
        ...
        for (let b of fromEnum(this.bo.a)) {
            let c = new ContentControl();
            let d = this.c6(b);
            let e = b.b0;
            let f = b.isOthersSlice ? this.eg : (this.bj != null && this.bj.count > 0) ? this.bj.item(this.ca._inner[b.a5]) : null;
            f = (f == null && this.bi.count > 0) ? this.bi.item(this.ca._inner[b.a5]) : f;
            c.content = ((() => {
                let $ret = new PieSliceDataContext();
                $ret.series = this.h6.c;
                $ret.slice = b;
                $ret.item = b.dataContext;
                $ret.itemBrush = e;
                $ret.legendLabel = f != null ? f.toString() : null;
                $ret.itemLabel = d != null ? d.toString() : null;
                $ret.percentValue = this.cs(b);
            ...
            if (this.ba != null && !g.isOthersSlice) {
                let i = this.ba.i(g);
                g.legendLabel = i;
            }
            if (this.bb != null && g.isOthersSlice) {
                let j = this.bb.i(g);
                g.legendLabel = j;
            }
...
export class ArcItem extends Base {
    ...
    o(a, b) {
        ...
        let o = e.count;
        let p = f.count > 0;
        let q = PieChartBase.c0(a);
        let r = PieChartBase.c0(a);
        if (p) {
            o++;
        }
        for (let s = 0; s < o; s++) {
...
export class RingSeriesBase extends Control {
    constructor() {
        ...
        this.aw = null;
        this.c6 = null;
        this.ee = { $type: Point_$type, x: 0, y: 0 };
        this.as = (a, b) => this.c1(a, b.propertyName, b.oldValue, b.newValue);
        this.propertyUpdated = delegateCombine(this.propertyUpdated, this.as);
        this.aw = this.av();
        this.cy(this.aw);
        this.aw.k();
        this.a9 = (a, b) => this.cs(b.action, b.position, b.count, b.propertyName);
    }
    c3(a, b, c) {
...
RingSeriesBase.dl = DependencyProperty.i("LabelTemplate", DataTemplate.$, RingSeriesBase.$, new PropertyMetadata(2, null, (a, b) => (typeCast(RingSeriesBase.$, a)).c3("LabelTemplate", b.oldValue, b.newValue)));
RingSeriesBase.dc = DependencyProperty.i("IsSurfaceInteractionDisabled", Boolean_$type, RingSeriesBase.$, new PropertyMetadata(2, false, (a, b) => a.c3("IsSurfaceInteractionDisabled", b.oldValue, b.newValue)));
...
export class XamDoughnutChart extends Control {
    ...
    *_ay(a) {
        for (let b of fromEnum(this.series)) {
            if (PieChartBase.b6(a, b.itemsSource)) {
                yield b;
            }
        }
    }
...
XamDoughnutChart.cc = DependencyProperty.i("InnerExtent", Number_$type, XamDoughnutChart.$, new PropertyMetadata(2, 40, (a, b) => {
    let c = b.newValue;
    if (c < 0 || c > 100) {
        if (b.oldValue != null) {
            a.a3 = b.oldValue;
...
export class RingSeriesBaseView extends Base {
    ...
    j(a, b, c, d, e) {
        ...
        let i = BrushUtil.e("doughnut", a, b, c, g);
        b = i.p2;
        c = i.p3;
        d = new Brush();
...
export class XamDoughnutChartView extends Base {
    ...
    n(a) {
        this.t(a, (b, c) => b.ak(c), "mouseUp");
    }
    k(a) {
        this.t(a, (b, c) => b.ah(c), "mouseDown");
    }
    l(a) {
        this.t(a, (b, c) => b.ai(c), "mouseLeave");
    }
    m(a, b, c) {
        this.t(a, (d, e) => d.aj(e, b, c), "mouseOver");
    }
    g() {
