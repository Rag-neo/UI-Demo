 ...
 * @hidden
 */
export class TreemapLayoutCalculator extends Base {
    static c(a, b, c, d) {
        let e = a.e();
        let f = d.f;
 ...
 * @hidden
 */
export class TreemapNodeStyle extends Base {
    constructor() {
        super(...arguments);
        this.a = null;
 ...
 * @hidden
 */
export class TreemapNodeStyleMappingCollection extends ObservableCollection$1 {
    constructor() {
