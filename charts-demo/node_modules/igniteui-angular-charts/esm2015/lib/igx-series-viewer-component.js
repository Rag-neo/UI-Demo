...
export class IgxSeriesViewerComponent {
    constructor() {
        this.__p = null;
    ...
    */
    get refreshCompleted() {
        if (this._refreshCompleted == null) {
            ...
            this.i.refreshCompleted = delegateCombine(this.i.refreshCompleted, (o, e) => {
                let outerArgs = new IgxRefreshCompletedEventArgs();
                outerArgs._provideImplementation(e);
                if (this.beforeRefreshCompleted) {
                    this.beforeRefreshCompleted(this, outerArgs);
                }
                this._refreshCompleted.emit({
                    sender: this,
                    args: outerArgs
                });
            });
