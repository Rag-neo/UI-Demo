...
*/
export class IgxSeriesComponent {
    constructor() {
        //@Input()
...
*/
    ...
    */
    ...
    getSeriesValuePositionFromSeriesPixel(mouse, useInterpolation, skipUnknowns) {
        let iv = this.i.ln(toPoint(mouse), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    ...
    */
    toWorldPosition(seriesPoint) {
        let iv = this.i.lp(toPoint(seriesPoint));
        return fromPoint(iv);
    }
    /**
    ...
    */
    fromWorldPosition(world) {
        let iv = this.i.lh(toPoint(world));
        return fromPoint(iv);
    }
    /**
