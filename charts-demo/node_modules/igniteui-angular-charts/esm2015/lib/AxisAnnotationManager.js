...
*/
import { Base, runOn, delegateRemove, delegateCombine, fromEnum, markType } from "igniteui-angular-core";
...
export class AxisAnnotationManager extends Base {
    ...
    onAddAnnotations(a) {
        let b = 0;
        for (let c = 0; c < a.am.count; c++) {
            b = this.a(a, a.am._inner[c], b);
        }
        for (let d = 0; d < a.al.count; d++) {
    ...
    a(a, b, c) {
        let d = NaN;
        d = b.value;
        let e = new LabelPosition(a.ed(d));
        if (a.b5) {
            let f = a;
            if (f.categoryMode == 2) {
                let g = a.bh.mr;
