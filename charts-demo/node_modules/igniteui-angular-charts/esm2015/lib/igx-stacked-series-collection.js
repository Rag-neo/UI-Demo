...
export class IgxStackedSeriesCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgxStackedFragmentSeriesComponent.$type, StackedFragmentSeries_internal.$type, 0);
