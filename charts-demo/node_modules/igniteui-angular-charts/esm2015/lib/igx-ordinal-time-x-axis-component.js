...
let IgxOrdinalTimeXAxisComponent = IgxOrdinalTimeXAxisComponent_1 = class IgxOrdinalTimeXAxisComponent extends IgxCategoryXAxisComponent {
    constructor() {
        super();
...
IgxOrdinalTimeXAxisComponent = IgxOrdinalTimeXAxisComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxCategoryXAxisComponent, useExisting: forwardRef(() => IgxOrdinalTimeXAxisComponent_1) }, { provide: IgxCategoryAxisBaseComponent, useExisting: forwardRef(() => IgxOrdinalTimeXAxisComponent_1) }, { provide: IgxAxisComponent, useExisting: forwardRef(() => IgxOrdinalTimeXAxisComponent_1) }],
