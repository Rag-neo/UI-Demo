...
SeriesViewer.lb = DependencyProperty.i("Legend", IChartLegend_$type, SeriesViewer.$, new PropertyMetadata(2, null, (a, b) => {
    let c = typeCast(SeriesViewer.$, a);
    c.ji("Legend", b.oldValue, b.newValue);
}));
SeriesViewer.k0 = DependencyProperty.i("AnimateSeriesWhenAxisRangeChanges", Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, false, (a, b) => {
    let c = typeCast(SeriesViewer.$, a);
...
Axis.ik = DependencyProperty.i("UseEnhancedIntervalManagement", Boolean_$type, Axis.$, new PropertyMetadata(2, false, (a, b) => a.g5("UseEnhancedIntervalManagement", b.oldValue, b.newValue)));
Axis.d7 = 7;
...
CategoryAxisBase.ky = DependencyProperty.i("ItemsSource", IEnumerable_$type, CategoryAxisBase.$, new PropertyMetadata(2, null, (a, b) => {
...
NumericAxisBase.li = DependencyProperty.i("TickmarkValues", TickmarkValues.$, NumericAxisBase.$, new PropertyMetadata(1, (a, b) => a.g5("TickmarkValues", b.oldValue, b.newValue)));
...
Series.e5 = 0;
Series.k3 = DependencyProperty.i("VisibilityProxy", Visibility_$type, Series.$, new PropertyMetadata(2, enumGetBox(Visibility_$type, 0), (a, b) => a.raisePropertyChanged("VisibilityProxy", b.oldValue, b.newValue)));
Series.ke = DependencyProperty.i("ItemsSource", IEnumerable_$type, Series.$, new PropertyMetadata(2, null, (a, b) => {
...
Series.ki = DependencyProperty.i("Legend", IChartLegend_$type, Series.$, new PropertyMetadata(2, null, (a, b) => {
    let c = typeCast(Series.$, a);
    c.raisePropertyChanged("Legend", b.oldValue, b.newValue);
}));
Series.kf = DependencyProperty.i("LegendItemBadgeTemplate", DataTemplate.$, Series.$, new PropertyMetadata(2, null, (a, b) => {
    let c = typeCast(Series.$, a);
...
Series.kg = DependencyProperty.i("LegendItemTemplate", DataTemplate.$, Series.$, new PropertyMetadata(2, null, (a, b) => {
    let c = typeCast(Series.$, a);
...
Series.j8 = DependencyProperty.i("DiscreteLegendItemTemplate", DataTemplate.$, Series.$, new PropertyMetadata(2, null, (a, b) => {
    let c = typeCast(Series.$, a);
    c.raisePropertyChanged("DiscreteLegendItemTemplate", b.oldValue, b.newValue);
}));
Series.kb = DependencyProperty.i("Index", Number_$type, Series.$, new PropertyMetadata(2, -1, (a, b) => {
    let c = typeCast(Series.$, a);
...
MarkerSeries.ms = DependencyProperty.i("MarkerBrush", Brush.$, MarkerSeries.$, new PropertyMetadata(1, (a, b) => {
