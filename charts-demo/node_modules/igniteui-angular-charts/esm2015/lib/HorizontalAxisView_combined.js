...
export class XamSparklineView extends Base {
    constructor() {
        ...
        this.bu._visibility = 1;
        let a = this.v;
        a.item(ClearMessage_Spark.$, (b) => this.ai(typeCast(ClearMessage_Spark.$, b)));
        a.item(PolygonMessage_Spark.$, (b) => this.bb(typeCast(PolygonMessage_Spark.$, b)));
        a.item(ColumnMessage_Spark.$, (b) => this.a4(typeCast(ColumnMessage_Spark.$, b)));
        a.item(WinLossColumnMessage_Spark.$, (b) => this.bi(typeCast(WinLossColumnMessage_Spark.$, b)));
        a.item(MarkerMessage_Spark.$, (b) => this.a7(typeCast(MarkerMessage_Spark.$, b)));
        a.item(NormalRangeMessage_Spark.$, (b) => this.bc(typeCast(NormalRangeMessage_Spark.$, b)));
        a.item(TrendLineMessage_Spark.$, (b) => this.bf(typeCast(TrendLineMessage_Spark.$, b)));
        a.item(TooltipMessage_Spark.$, (b) => this.bd(typeCast(TooltipMessage_Spark.$, b)));
        a.item(ToooltipTemplateMessage_Spark.$, (b) => this.be(typeCast(ToooltipTemplateMessage_Spark.$, b)));
        a.item(ContainerMessage_Spark.$, (b) => this.aj(typeCast(ContainerMessage_Spark.$, b)));
        a.item(PixelRatioMessage_Spark.$, (b) => this.av(typeCast(PixelRatioMessage_Spark.$, b)));
        a.item(BrushChangedMessage_Spark.$, (b) => this.a2(typeCast(BrushChangedMessage_Spark.$, b)));
        a.item(ContainerResizedMessage_Spark.$, (b) => this.as());
        a.item(VisibilityMessage_Spark.$, (b) => this.bh(typeCast(VisibilityMessage_Spark.$, b)));
        a.item(NumberChangedMessage_Spark.$, (b) => this.ba(typeCast(NumberChangedMessage_Spark.$, b)));
    ...
    as() {
        ...
        this.r = true;
        this.ao(this.l.q);
        let a = this.ad.rootWrapper.width(), b = this.ad.rootWrapper.height();
        let c, d, e;
        c = this.ae;
        d = this.af;
        e = this.ag;
    ...
    al(a) {
        let x_ = 0, y_ = 0;
        let v_ = null, t_ = null, i_ = this.ad;
        {
            if (a != null) {
                t_ = this.ah;
                x_ = a.xOffset + 6;
...
export class XamSparkline extends Control {
    constructor() {
        ...
        this.au = null;
        this.al = null;
        this.aj = new MessageChannel_Spark();
        this.a0 = NaN;
        this.az = NaN;
        this.av = null;
        this.ai = null;
        ...
        this.ar = new VerticalAxisView(this);
        this.ai = new HorizontalAxisView(this);
        this.an = new SparklineConnector(this, new XamSparklineView());
    }
    get toolTip() {
...
XamSparkline.bf = -1;
XamSparkline.bb = -1;
XamSparkline.ev = DependencyProperty.i("ToolTip", Base.$, XamSparkline.$, new PropertyMetadata(2, null, (a, b) => (typeCast(XamSparkline.$, a)).dr("ToolTip", b.oldValue, b.newValue)));
XamSparkline.bo = -1;
