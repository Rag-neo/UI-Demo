...
export class IgxRadialBaseComponent extends IgxMarkerSeriesComponent {
    constructor() {
        super();
    }
    /**
    ...
    */
    get angleAxis() {
        ...
        if (!this.i.m4.externalObject) {
            let e = IgxCategoryAngleAxisComponent._createFromInternal(this.i.m4);
            if (e) {
    ...
    */
    get valueAxis() {
        ...
        if (!this.i.m6.externalObject) {
            let e = IgxNumericRadiusAxisComponent._createFromInternal(this.i.m6);
            if (e) {
