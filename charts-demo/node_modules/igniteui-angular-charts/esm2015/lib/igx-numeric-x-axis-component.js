...
let IgxNumericXAxisComponent = IgxNumericXAxisComponent_1 = class IgxNumericXAxisComponent extends IgxStraightNumericAxisBaseComponent {
    constructor() {
        super();
    }
...
IgxNumericXAxisComponent = IgxNumericXAxisComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxStraightNumericAxisBaseComponent, useExisting: forwardRef(() => IgxNumericXAxisComponent_1) }, { provide: IgxNumericAxisBaseComponent, useExisting: forwardRef(() => IgxNumericXAxisComponent_1) }, { provide: IgxAxisComponent, useExisting: forwardRef(() => IgxNumericXAxisComponent_1) }],
