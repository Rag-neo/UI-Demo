...
let IgxBarFragmentComponent = IgxBarFragmentComponent_1 = class IgxBarFragmentComponent extends IgxColumnFragmentComponent {
    constructor() {
        super();
    }
...
IgxBarFragmentComponent = IgxBarFragmentComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxColumnFragmentComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxFragmentBaseComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxHorizontalAnchoredCategorySeriesComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxAnchoredCategorySeriesComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxCategorySeriesComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxMarkerSeriesComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxBarFragmentComponent_1) }],
