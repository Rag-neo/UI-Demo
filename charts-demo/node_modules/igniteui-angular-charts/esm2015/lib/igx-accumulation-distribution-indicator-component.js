...
let IgxAccumulationDistributionIndicatorComponent = IgxAccumulationDistributionIndicatorComponent_1 = class IgxAccumulationDistributionIndicatorComponent extends IgxStrategyBasedIndicatorComponent {
    constructor() {
        super();
    }
...
IgxAccumulationDistributionIndicatorComponent = IgxAccumulationDistributionIndicatorComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxStrategyBasedIndicatorComponent, useExisting: forwardRef(() => IgxAccumulationDistributionIndicatorComponent_1) }, { provide: IgxFinancialIndicatorComponent, useExisting: forwardRef(() => IgxAccumulationDistributionIndicatorComponent_1) }, { provide: IgxFinancialSeriesComponent, useExisting: forwardRef(() => IgxAccumulationDistributionIndicatorComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxAccumulationDistributionIndicatorComponent_1) }],
