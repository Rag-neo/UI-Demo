...
export class CategoryBucketCalculator extends Base {
    ...
    g(a) {
        ...
        if (i == null || i.i$b == null) {
            let j = new ScalerParams(0, b, c, e.ca, g);
            let k = Math.floor(e.d2(h.left, j, 0));
            let l = Math.ceil(e.d2(h.right, j, 0));
            if (e.ca) {
...
export class CategoryFramePreparerBase extends FramePreparer {
    ...
    t(a, b, c, d, e) {
        ...
        let k = a.m;
        let l = a.l;
        let m = typeCast(NumericAxisBase.$, a.c) !== null && a.c.j1;
        let n = a.f;
...
export class CategorySeries extends MarkerSeries {
    constructor() {
        ...
        this.nq = null;
        this.nr = null;
        this.nc = new CategoryFrame(3);
        this.ne = new CategoryFrame(3);
        this.nb = new CategoryFrame(3);
        this.nd = new CategoryFrame(3);
        this.ni = null;
        this.nm = null;
        this.ni = new CategorySeriesRenderManager();
        this.nm = new CategoryTransitionSourceFramePreparer();
        this.nw = false;
        this.nv = false;
    ...
    get nt() {
        if (this.ns == null) {
            this.ns = DVContainer.instance.createInstance(ICategorySeriesInteractionManager_$type, () => this.b2.n);
        }
        return this.ns;
    }
    ch(a, b, c) {
        ...
        let f = new ScalerParams(1, this.bs.mr, this.lz, e.ca);
        f.c = d;
        let g = this.fetchYAxis();
        let h = new ScalerParams(1, this.bs.mr, this.lz, g.ca);
        h.c = d;
        let i = this.bs.mr;
        let j = this.lz;
        ...
        this.l1.cc((m) => {
            if (m._visibility == 0) {
                ...
                let o = m.n;
                let p = m.o;
                if (o < this.lz.left || o > this.lz.right || p < this.lz.top || p > this.lz.bottom) {
                    return;
                }
    ...
    at(a, b) {
        if (this.nz) {
            let c = this.no(a, b, this.nq);
            this.nq = c;
            return c;
        }
        else {
            let d = this.nn(a, b, this.nq);
            this.nq = d;
            return d;
        }
    }
    ...
    om(a, b) {
        ...
        let g = new ScalerParams(0, a.bs, a.br, e.ca, f);
