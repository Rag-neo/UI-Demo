...
import { Number_$type, fromEnum, Boolean_$type, markType } from "igniteui-angular-core";
...
export class RadialAxisLabelPanel extends HorizontalAxisLabelPanelBase {
    ...
    get dc() {
        return this.ac.ax != null && (this.ac.ax.c != 5 && this.ac.ax.c != 4);
    }
    get db() {
        return !this.dc;
    }
    ...
    cb(a, b) {
        ...
        if (this.ac.ax != null && this.ac.ax.c == 4) {
            d = d * -1;
        }
        this.da.a4(a, b, d);
    }
