...
export class IgxTimeAxisLabelFormatCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgxTimeAxisLabelFormatComponent.$type, TimeAxisLabelFormat_internal.$type, 0);
