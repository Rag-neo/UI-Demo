...
let IgxScatterPolylineSeriesComponent = IgxScatterPolylineSeriesComponent_1 = class IgxScatterPolylineSeriesComponent extends IgxShapeSeriesBaseComponent {
    constructor() {
        super();
    }
...
IgxScatterPolylineSeriesComponent = IgxScatterPolylineSeriesComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxShapeSeriesBaseComponent, useExisting: forwardRef(() => IgxScatterPolylineSeriesComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxScatterPolylineSeriesComponent_1) }],
