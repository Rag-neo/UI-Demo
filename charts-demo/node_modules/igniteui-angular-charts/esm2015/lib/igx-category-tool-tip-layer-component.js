...
let IgxCategoryToolTipLayerComponent = IgxCategoryToolTipLayerComponent_1 = class IgxCategoryToolTipLayerComponent extends IgxAnnotationLayerComponent {
    constructor() {
        super();
    }
    ...
    */
    get targetAxis() {
        ...
        if (!this.i.m5.externalObject) {
            let e = IgxAxisComponent._createFromInternal(this.i.m5);
            if (e) {
...
IgxCategoryToolTipLayerComponent = IgxCategoryToolTipLayerComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxAnnotationLayerComponent, useExisting: forwardRef(() => IgxCategoryToolTipLayerComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxCategoryToolTipLayerComponent_1) }],
