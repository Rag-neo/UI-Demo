...
let IgxScatterContourSeriesComponent = IgxScatterContourSeriesComponent_1 = class IgxScatterContourSeriesComponent extends IgxScatterTriangulationSeriesComponent {
    constructor() {
        super();
    }
    ...
    */
    get fillScale() {
        ...
        if (!this.i.nl.externalObject) {
            let e = IgxValueBrushScaleComponent._createFromInternal(this.i.nl);
            if (e) {
    ...
    */
    get valueResolver() {
        ...
        if (!this.i.nj.externalObject) {
            let e = IgxContourValueResolverComponent._createFromInternal(this.i.nj);
            if (e) {
...
IgxScatterContourSeriesComponent = IgxScatterContourSeriesComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxScatterTriangulationSeriesComponent, useExisting: forwardRef(() => IgxScatterContourSeriesComponent_1) }, { provide: IgxSeriesComponent, useExisting: forwardRef(() => IgxScatterContourSeriesComponent_1) }],
