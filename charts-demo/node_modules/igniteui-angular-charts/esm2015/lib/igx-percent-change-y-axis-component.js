...
let IgxPercentChangeYAxisComponent = IgxPercentChangeYAxisComponent_1 = class IgxPercentChangeYAxisComponent extends IgxNumericYAxisComponent {
    constructor() {
        super();
    }
...
IgxPercentChangeYAxisComponent = IgxPercentChangeYAxisComponent_1 = tslib_1.__decorate([
    Component({
        ...
        template: ``,
        providers: [{ provide: IgxNumericYAxisComponent, useExisting: forwardRef(() => IgxPercentChangeYAxisComponent_1) }, { provide: IgxStraightNumericAxisBaseComponent, useExisting: forwardRef(() => IgxPercentChangeYAxisComponent_1) }, { provide: IgxNumericAxisBaseComponent, useExisting: forwardRef(() => IgxPercentChangeYAxisComponent_1) }, { provide: IgxAxisComponent, useExisting: forwardRef(() => IgxPercentChangeYAxisComponent_1) }],
