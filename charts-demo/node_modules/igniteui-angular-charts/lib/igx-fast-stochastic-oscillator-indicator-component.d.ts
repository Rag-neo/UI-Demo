...
export declare const IgxFastStochasticOscillatorIndicatorComponent_PROVIDERS: ({
...
export declare class IgxFastStochasticOscillatorIndicatorComponent extends IgxStrategyBasedIndicatorComponent {
    ...
    */
    period: number;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxFastStochasticOscillatorIndicatorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxFastStochasticOscillatorIndicatorComponent, "igx-fast-stochastic-oscillator-indicator", never, { "period": "period"; }, {}, never, never>;
}

//# sourceMappingURL=igx-fast-stochastic-oscillator-indicator-component.d.ts.map