...
export declare const IgxStandardDeviationIndicatorComponent_PROVIDERS: ({
...
export declare class IgxStandardDeviationIndicatorComponent extends IgxStrategyBasedIndicatorComponent {
    ...
    */
    period: number;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxStandardDeviationIndicatorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxStandardDeviationIndicatorComponent, "igx-standard-deviation-indicator", never, { "period": "period"; }, {}, never, never>;
}

//# sourceMappingURL=igx-standard-deviation-indicator-component.d.ts.map