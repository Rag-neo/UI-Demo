...
*/
export declare class IgxAssigningCategoryStyleEventArgs extends IgxAssigningCategoryStyleEventArgsBase {
    protected createImplementation(): AssigningCategoryStyleEventArgs_internal;
    /**
                                 * @hidden
                                 */
    readonly i: AssigningCategoryStyleEventArgs_internal;
    constructor();
    /**
