import { Base, Type, IEnumerable } from "igniteui-angular-core";
...
export declare class XamSparklineView extends Base implements ISchedulableRender {
    ...
    private aw;
    postRender(): void;
    am(a: SparklineVisualData): void;
    preRender(): void;
    isValid(): boolean;
    n(a: string): FontInfo;
    private ay;
    ao(a: XamSparkline): void;
    at(): void;
    ar(): void;
}
/**
...
export declare class XamSparkline extends Control {
    ...
    bk: number;
    bj: number;
    ao: SparklineDisplayType;
    aq: UnknownValuePlotting;
    bt: any;
    br: any;
    ax(): boolean;
    c1(a: any): string;
    ...
    au: BindingFormatter;
    private al;
    am: ServiceProvider_Spark;
    private aj;
    ak: MessageChannel_Spark;
    private a0;
    a4: number;
    private az;
    a3: number;
    av: IFastItemColumn$1<any>;
    ai: HorizontalAxisView;
    ar: VerticalAxisView;
