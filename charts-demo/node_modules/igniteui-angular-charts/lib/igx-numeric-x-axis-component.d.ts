...
export declare const IgxNumericXAxisComponent_PROVIDERS: {
    provide: typeof IgxAxisComponent;
    useExisting: Type<any>;
}[];
export declare class IgxNumericXAxisComponent extends IgxStraightNumericAxisBaseComponent {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxNumericXAxisComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxNumericXAxisComponent, "igx-numeric-x-axis", never, {}, {}, never, never>;
}

//# sourceMappingURL=igx-numeric-x-axis-component.d.ts.map