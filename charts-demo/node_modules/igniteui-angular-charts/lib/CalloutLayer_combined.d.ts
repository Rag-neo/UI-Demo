...
export declare class CalloutLayer extends AnnotationLayer {
    ...
    private ng;
    pl: string;
    nm: IFastItemColumn$1<any>;
    private nh;
    po: string;
    nn: IFastItemColumn$1<any>;
    private ni;
    pb: string;
    ...
    qv: Brush;
    qu: Brush;
    readonly q0: Thickness;
    od: number;
    of: number;
    oe: number;
    oc: number;
    m5: CalloutCollisionMode;
    og: number;
    oh: number;
    ph: string;
    private nc;
    readonly nd: FontInfo;
    ...
    protected p1(a: CalloutLayerFrame, b: boolean): void;
