...
export declare const IgxOrdinalTimeXAxisComponent_PROVIDERS: {
    provide: typeof IgxAxisComponent;
    useExisting: Type<any>;
}[];
export declare class IgxOrdinalTimeXAxisComponent extends IgxCategoryXAxisComponent {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxOrdinalTimeXAxisComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxOrdinalTimeXAxisComponent, "igx-ordinal-time-x-axis", never, { "dateTimeMemberPath": "dateTimeMemberPath"; "labelFormats": "labelFormats"; "minimumValue": "minimumValue"; "maximumValue": "maximumValue"; }, {}, never, never>;
}

//# sourceMappingURL=igx-ordinal-time-x-axis-component.d.ts.map