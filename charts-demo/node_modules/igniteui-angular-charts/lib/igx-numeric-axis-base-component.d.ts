...
export declare const IgxNumericAxisBaseComponent_PROVIDERS: {
...
export declare abstract class IgxNumericAxisBaseComponent extends IgxAxisComponent {
    ...
    */
    ...
    readonly actualMinimumValueChange: EventEmitter<number>;
    private _actualMaximumValueChange;
    readonly actualMaximumValueChange: EventEmitter<number>;
