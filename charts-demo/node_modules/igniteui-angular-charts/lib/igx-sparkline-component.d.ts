import { OnDestroy, TemplateRef, Injector, ComponentFactoryResolver, AfterContentInit, Renderer2, NgZone, ViewContainerRef } from '@angular/core';
...
export declare const IgxSparklineComponent_PROVIDERS: any[];
/**
 * Represents a sparkline chart.
*/
export declare class IgxSparklineComponent implements AfterContentInit, OnDestroy {
    private _renderer;
    private _elRef;
    private _ngZone;
